...
const features = [
  {
    ...
    description:
      "Simplify HR workflows with pre-designed templates for:Job descriptions,Employee handbooks,Performance review forms,Leave requests",
  },
  {
    ...
    description:
      "Stay ahead of regulations with up-to-date content on:Labor laws and employee rights,Workplace safety standards,Anti-harassment and anti-discrimination policies",
  },
  {
    ...
    title: "Employee Development Materials",
    description:
      "Support employee growth with a wide range of tools, including:Soft skill training guides,Leadership development plans,Career progression frameworks",
  },
  {
    ...
    title: "Onboarding & Offboarding Resources",
    description:
      "Seamlessly transition employees with step-by-step guides for:New hire orientation,Offboarding processes,Exit interviews",
  },
  {
    ...
    title: "Learning Modules & Training Content",
    description:
      "Boost knowledge with interactive learning modules on:Diversity and inclusion,Workplace productivity,Mental health and well-being",
  },
  {
    ...
    title: "HR Metrics & Analytics Tools",
    description:
      "Make data-driven decisions with resources that help track and analyze HR performance: Dashboard templates for workforce analytics.",
  },
];
