...
const HERO_BUTTONS = [
  ...
  const features = [
    {
      title: "Hassle-Free Homework Assignments",
      description: "Easily create and distribute assignments to students with just a few clicks. "
    },
    {
      title: "Real-Time Progress Tracking",
      description: "Quickly identify who’s on track and who needs additional support, ensuring no student falls behind."
    },
    {
      title: "Seamless Collaboration",
      description: "Enable students and parents to access assignments, deadlines, and teacher feedback all in one place. "
    },
    // {
        ...
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-[55%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-start mt-6 w-full text-2xl font-medium max-md:mt-10 max-md:max-w-full">
              ...
              Simplify Homework Management with Scholar Clone LMS
              </div>
              <div className="self-stretch text-lg mt-12 text-black max-md:mt-10 max-md:max-w-full">
              Say goodbye to tedious administrative tasks and hello to an organized, efficient, and engaging homework experience.              </div>
          ...
          <div className="flex flex-col ml-5 w-[45%] max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="/lms_design_three_images/image 4.png"
...
<div className="sm:flex lg:hidden overflow-hidden flex-col justify-center items-start font-inter px-16 py-10 w-full max-md:px-5 max-md:py-24 max-md:max-w-full" style={{
        ...
        <div className="lg:flex gap-5 max-md:flex-col">
          <div className="flex flex-col lg:w-[55%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-start mt-6 w-full text-1xl font-medium max-md:mt-10 max-md:max-w-full">
              ...
              Say goodbye to tedious administrative tasks and hello to an organized, efficient, and engaging homework experience.              </div>
              <div className="flex lg:flex-wrap gap-10 text-[12px] mt-6 text-xs max-w-full text-white w-[547px] max-md:mt-10">
                {ctaButtons.map((button, index) => (
                  <button 
                  key={index}
                  className={button.className}
          ...
          <div className="lg:flex flex-col mt-3 lg:w-[45%] max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="/lms_design_three_images/image 4.png"
              alt="User and teacher management interface demonstration"
    ...
    <div className="rounded-none">
      <div className="lg:flex sm:hidden mx-20 mt-24 max-md:flex-col">
        <div className="flex flex-col w-6/12 pr-36 max-md:ml-0 max-md:w-full">
          <img
            loading="lazy"
            src="lms_design_three_images/image 5.jpg"
        ...
        <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
          ...
          Why Choose Scholar Clone&rsquo;s Homework Management Module?
      </h1>
      ...
      <div className="sm:flex lg:hidden mx-10 mt-12 max-md:flex-col">
        ...
        <div className="lg:flex flex-col w-12/12 max-md:ml-0 max-md:w-full">
          <div className="flex flex-col self-stretch my-auto w-full max-md:mt-10 max-md:max-w-full">
          <h1 className="z-10 self-start mt-0 text-2xl mr-2   font-inter tracking-tighter max-md:max-w-full" style={{
            color:'rgba(28, 81, 161, 1)'
          }}>
          Why Choose Scholar Clone&rsquo;s Homework Management Module?
      </h1>
      <div className="z-10 mt-2 max-md:mt-10 max-md:max-w-full">
        <p className="text-sm mr-5 font-interregular">Tackle the challenges of managing visitors, inquiries, and appointments with ease:</p>
        {features.map((feature, index) => (
          <div key={index} className="mb-1">
          <ul className="list-disc pl-3 mr-6">
    ...
    <h1 className="lg:text-4xl sm:text-2xl text-center font-intersemibold lg:mt-40 sm:mt-10"style={{
           ...
           Key Features of the Homework Management Module
    </h1>
    <Features />
    <Benefits />
      ...
      <div className="lg:flex sm:hidden gap-5 max-md:flex-col">
        ...
        <div className="flex flex-col w-[78%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col w-full items-center justify-center pr-36 text-blue-800 max-md:max-w-full">
            ...
            Take Homework Management to the Next Level
            </div>
            <div className="mt-8 text-2xl font-interregular max-md:mr-2.5 max-md:max-w-full">
            Simplify your workload with automated tools for creating, <br/> assigning,and grading homework. 
            </div>
