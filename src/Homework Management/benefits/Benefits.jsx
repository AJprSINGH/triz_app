    ...
    >
      ...
      <div className="flex flex-wrap max-w-full w-full items-center justify-center mt-7">
        ...
        <div className="my-auto text-center justify-center text-3xl font-inter"style={{
          ...
          Benefits from Scholar Clone&rsquo;s Homework Management
        </div>
      </div>
        ...
        <div className="flex flex-wrap gap-5 justify-center">
          ...
          <div className="flex flex-col w-2/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              Automate repetitive tasks like distributing assignments and tracking submissions,  focus on instruction.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Boost Accountability</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              With clear deadlines students stay organized and take greater responsibility for their learning..
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Enhance Communication</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Foster stronger connections between teachers, students, and parents with transparent assignment .
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Improve Learning Outcomes</div>
              <div className="mt-4 text-sm  opacity-70 leading-7 w-[350px]">
              By making homework a structured and collaborative process, students stay engaged, motivated, and ready to excel.
              </div>
              {/* <img
                loading="lazy"
