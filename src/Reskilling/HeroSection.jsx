...
const HERO_BUTTONS = [
  ...
  const features = [
    {
      ...
      description: "Tailor courses to align with employee career goals and organizational needs."
    },
    {
      title: "Expert-Curated Course Library",
      description: "Access a wide range of topics, from technical skills to leadership development."
    },
    {
      title: "AI-Driven Recommendations",
      description: "Deliver personalized course suggestions to each employee based on their role and aspirations."
    },
    // {
  ...
  const ctaButtons = [
    {
      text: "Future-Proof Your Team Today! ",
        ...
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-[55%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-start mt-6 w-full text-2xl font-medium max-md:mt-10 max-md:max-w-full">
              ...
              Unlock the Potential of Your Workforce with Reskilling and Upskilling
              </div>
              <div className="self-stretch text-lg mt-12 text-black max-md:mt-10 max-md:max-w-full">
              Equip your employees with the skills of tomorrow using Scholar Clone&rsquo;s Reskilling/Upskilling Course Library Module. Create a future-ready workforce by fostering continuous learning, career growth, and organizational success—all in one platform.
              </div>
...
<div className="sm:flex lg:hidden overflow-hidden flex-col justify-center items-start font-inter px-16 py-10 w-full max-md:px-5 max-md:py-24 max-md:max-w-full" style={{
        ...
        <div className="lg:flex gap-5 max-md:flex-col">
          <div className="flex flex-col lg:w-[55%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-start mt-3 w-full text-1xl font-medium max-md:mt-10 max-md:max-w-full">
              ...
              <div className="flex lg:flex-wrap gap-10 text-[10px] mt-6 mb-3 max-w-full text-white w-[547px] max-md:mt-10">
                {ctaButtons.map((button, index) => (
                  <button 
                  key={index}
                  className={button.className}
    ...
    <div className="rounded-none">
      <div className="lg:flex sm:hidden mx-20 mt-24 max-md:flex-col">
        ...
        <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
          ...
          Redefine Learning and Development in Your Organization
      </h1>
      <div className="z-10 mt-4 max-md:mt-10 max-md:max-w-full">
        <p className="text-lg font-interregular">Stay ahead in a competitive world with a platform that inspires learning and growth:</p>
      ...
      <div className="z-10 mt-4 max-md:mt-10 max-md:max-w-full">
        <p className="text-sm font-interregular">Stay ahead in a competitive world with a platform that inspires learning and growth:</p>
        {features.map((feature, index) => (
          <div key={index} className="mb-1">
          <ul className="list-disc pl-5">
    ...
    <h1 className="lg:text-4xl sm:text-2xl text-center font-intersemibold lg:mt-40 sm:mt-10"style={{
            ...
            Comprehensive Features That Drive Growth
    </h1>
    <Features />
    <Benefits />
    <div className="rounded-none lg:mx-40 sm:mx-10 lg:mt-20 sm:mt-10">
      <div className="lg:flex sm:hidden gap-5 max-md:flex-col">
        ...
        <div className="flex flex-col w-[78%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col w-full items-center justify-center pr-36 text-blue-800 max-md:max-w-full">
            ...
            Take the Leap Toward a Skilled Workforce
            </div>
            <div className="mt-8 text-2xl font-interregular max-md:mr-2.5 max-md:max-w-full">
            Your team&rsquo;s growth fuels your organization&rsquo;s success. Scholar Clone&rsquo;s Reskilling/Upskilling Course 
            Library Module ensures every employee has access to the tools they need to thrive.
            </div>
      ...
      >
        Explore the Course Library Now!
      </button>
    </div>
    </div>
          </div>
