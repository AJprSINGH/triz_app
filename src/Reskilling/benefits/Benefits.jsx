        ...
        <div className="flex flex-wrap gap-5 justify-center">
          ...
          <div className="flex flex-col w-2/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Enhanced Productivity</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Empower employees to excel in their roles with relevant skills.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Talent Retention</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Foster loyalty by supporting career growth and personal development.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Future-Proof Workforce</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Stay ahead of industry changes by reskilling for emerging trends.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Cost-Effective Learning</div>
              <div className="mt-4 text-sm  opacity-70 leading-7 w-[350px]">
              Save time and money with on-demand, scalable training options.
              </div>
              {/* <img
                loading="lazy"
