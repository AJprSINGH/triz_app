export const benefitsData = [
  {
    ...
    description:
      "Provide educators with tools for seamless lesson planning and tracking.",
  },
  {
    title: "Boost Educator Productivity",
    description:
      "Reduce time spent on manual tasks, focusing efforts on impactful teaching.",
  },
  {
