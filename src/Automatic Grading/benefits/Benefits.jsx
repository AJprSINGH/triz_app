  ...
  return (
    <div className="flex items-center justify-center">
      <div className="flex flex-col items-center justify-center pt-32 w-full max-w-screen-xl bg-white">
        <h1 className="lg:text-3xl sm:text-2xl sm:pr-3 font-lxesemibold leading-none text-center text-zinc-900 underline decoration-[rgba(34,226,127,1)] decoration-4">
        Benefits of the Automatic Grading System
        </h1>
