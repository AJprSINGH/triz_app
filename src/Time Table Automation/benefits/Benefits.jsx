        ...
        <div className="flex flex-wrap gap-5 justify-center">
          ...
          <div className="flex flex-col w-2/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              Automate timetable creation, reducing hours spent on manual adjustments.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Improve Efficiency</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Ensure optimized use of classrooms, faculty, and resources with smart scheduling.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Enhance Transparency</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Provide stakeholders with instant access to accurate schedules, minimizing confusion.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Minimize Errors</div>
              <div className="mt-4 text-sm  opacity-70 leading-7 w-[350px]">
              Avoid scheduling conflicts and double bookings with built-in validation checks.
              </div>
              {/* <img
                loading="lazy"
