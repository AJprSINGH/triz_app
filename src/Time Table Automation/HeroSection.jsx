  ...
  const features = [
    {
      ...
      description: "The Timetable Automation Module provides a smart, intuitive way to plan and manage academic schedules. "
    },
    {
      title: "Vendor & Purchase Orders",
      description: "It eliminates manual errors, optimizes resource allocation, and ensures students and staff are always informed about their schedules. "
    },
    {
      title: "Stock In/Out Logs",
      description: "From class timings to faculty availability, everything is efficiently managed in one place."
    },
    // {
...
<div className="flex overflow-hidden flex-col justify-center items-start font-inter px-16 py-10 w-full max-md:px-5 max-md:py-24 max-md:max-w-full" style={{
      ...
      <div className="-mb-6 w-full max-w-[1668px] max-md:mb-2.5 max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-[55%] max-md:ml-0 max-md:w-full">
            ...
            Flexible, and Efficient Timetables Made Easy
              </div>
              <div className="self-stretch text-lg mt-12 text-black max-md:mt-10 max-md:max-w-full">
              Designed for schools, colleges, and institutions, this tool ensures accurate, conflict-free timetables while adapting to the dynamic needs of your academic calendar.
              </div>
          ...
          <div className="flex flex-col ml-5 w-[45%] max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="/ai_design_images/image 4.png"
    ...
    <div className="rounded-none">
      <div className="flex mx-20 mt-24 max-md:flex-col">
        <div className="flex flex-col w-6/12 pr-36 max-md:ml-0 max-md:w-full">
          <img
            loading="lazy"
            src="ai_design_images/image 5.png"
    ...
    <h1 className="text-4xl text-center font-intersemibold mt-40"style={{
            ...
            Features That Meet Your Scheduling Needs
    </h1>
    <Features />
    <Benefits />
    <div className="rounded-none mx-40 mt-20">
      <div className="flex gap-5 max-md:flex-col">
        ...
        <div className="flex flex-col w-[78%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col w-full items-center justify-center pr-36 text-blue-800 max-md:max-w-full">
            ...
            Why Choose  Timetable Automation?
            </div>
            <div className="mt-8 text-2xl font-interregular max-md:mr-2.5 max-md:max-w-full">
            The Timetable Automation Module combines simplicity and power, making scheduling effortless for institutions of all sizes. 
            </div>
      ...
      >
  Get Started with Timetable Automation Today
      </button>
    </div>
    </div>
          </div>
