...
const HERO_BUTTONS = [
  ...
  const featureData = [
    {
      title: "Design Engaging Courses",
      description: "Build interactive and multimedia-rich lessons tailored to your curriculum."
    },
    {
      title: "Personalize Learning Paths",
      description: "Cater to individual student needs with adaptive course content."
    },
    {
      title: "Collaborate & Share",
      description: "Work with fellow educators to create and share best-in-class teaching materials."
    }
  ];
  const features = [
    {
      title: "Intuitive Course Builder",
      description: "Quickly add text, images, videos, quizzes, and assignments."
    },
    {
      title: "Multimedia Integration",
      description: "Add video explanations and tutorials to captivate students."
    },
    {
      title: "Adaptive Learning Features",
      description: "Monitor each student's performance and tailor content accordingly."
    },
    {
      title: "Collaborative Tools",
      description: "Collaborate with colleagues to co-create impactful courses."
    },
    {
      title: "Analytics and Insights",
      description: "Gain insights into course success and areas for improvement."
    }
  ];
...
<div className="lg:flex sm:hidden overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    ...
    Empower Educators.Enhance Learning.
    </h1>
    <h4 className="lg:text-lg sm:text-sm mt-20 font-intersemibold text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(18, 20, 29, 1)'
    }}>
The Teaching Tools – Create a Course Module in Scholar Clone LMS is the ultimate solution for educators to design, 
customize, and deliver impactful courses effortlessly. This powerful, user-friendly module is designed to inspire 
  creativity in lesson planning while ensuring an engaging and personalized learning experience for students.    </h4>
...
>
  ...
  >
    <div className="flex flex-col rounded-lg mx-40">
      ...
      Create Courses That Transform Learning
      </div>
      <div className="mt-14 w-full max-md:mt-10 max-md:max-w-full">
        <div className="lg:flex lg:gap-5 max-md:flex-col">
          {featureData.map((feature, index) => (
            <div key={index} className="flex lg:flex-col sm:flex-row lg:w-full sm:w-full  max-md:ml-0 max-md:w-full">
            <div className="flex overflow-hidden flex-col grow px-10 pt-8 pb-6 w-full tracking-tighter leading-9 text-center text-black bg-white rounded-lg max-md:px-5 max-md:mt-10">
              <div className="lg:text-2xl sm:text-1xl font-lxsemibold max-md:mr-1.5">
                {feature.title}
              </div>
  ...
  >
    <div className="flex flex-col rounded-lg lg:mx-40 sm:px-20">
      <div className="z-10 lg:self-center sm:text-center lg:ml-6 lg:text-2xl sm:text-lg mt-4 font-lxsemibold tracking-tighter leading-none text-center text-white max-md:max-w-full underline decoration-[rgba(34,226,127,1)] decoration-4">
      Create Courses That Transform Learning
      </div>
      <div className="mt-14 w-full max-md:mt-10 max-md:max-w-full">
    ...
    <div className="rounded-none">
      <div className="lg:flex mx-20 lg:mt-20 sm:mt-20 gap-20 max-md:flex-col">
        <div className="flex lg:flex-col lg:w-6/12  max-md:ml-0 max-md:w-full">
          <img
            loading="lazy"
            src="/lms_design_two_images/image 1.png"
    ...
    Take the first step toward transforming your<br/> teaching experience with Scholar Clone&rsquo;s 
    </h1>
