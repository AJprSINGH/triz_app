...
const features = [
  ...
  {
    title: "Accuracy: ",
    description: "Ensure all steps are completed correctly with minimal errors."
  },
  {
    title: "Employee Engagement: ",
    description: "Provide a welcoming and structured start for new hires."
  },
  {
    title: "Time Savings:",
    description: " Save time for both HR teams and new employees with streamlined processes."
  }
];
    ...
    <div className="rounded-none">
      <div className="flex mx-20 mt-20 max-md:flex-col">
          <div className="flex flex-col w-6/12 ml-10 -mr-32 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="hr_design_four_images/image 2.png"
