...
const HERO_BUTTONS = [
    { text: "Streamline Your Workforce Today! " },
    { text: "Request a Demo" }
  ];
  const featureData = [
    {
  ...
  const features = [
    {
      ...
      description: "Keep conversations flowing with instant messaging between HR, employees, and teams."
    },
    {
      title: "Announcements Made Easy",
      description: "Share updates, circulars, and policy changes with the click of a button."
    },
    {
      title: "Integrated Feedback Systems",
      description: "Collect and address employee feedback efficiently, boosting engagement and satisfaction."
    },
    // {
  ...
  const ctaButtons = [
    {
      text: "Experience the Future of HR Communication ",
        ...
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-[55%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-start mt-6 w-full text-2xl font-medium max-md:mt-10 max-md:max-w-full">
              ...
              In today&rsquo;s fast-paced world, effective communication is the backbone of every successful organization. Scholar Clone&rsquo;s Communication Tools Module bridges the gap between HR, employees, and management, ensuring a connected and informed workforce.
              </div>
          ...
          <div className="flex flex-col ml-5 w-[45%] max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="/hr_design_three_images/image 4.png"
...
<div className="sm:flex lg:hidden overflow-hidden flex-col justify-center items-start font-inter px-16 py-10 w-full max-md:px-5 max-md:py-24 max-md:max-w-full" style={{
      ...
      <div className="-mb-6 w-full max-w-[1668px] max-md:mb-2.5 max-md:max-w-full">
        <div className="lg:flex gap-5 max-md:flex-col">
          <div className="flex flex-col lg:w-[55%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-start mt-6 w-full text-1xl font-medium max-md:mt-10 max-md:max-w-full">
              ...
              <div className="flex lg:flex-wrap gap-10 text-[11px] mb-3 mt-6 max-w-full text-white w-[547px] max-md:mt-10">
                {ctaButtons.map((button, index) => (
                  <button 
                  key={index}
                  className={button.className}
    ...
    <div className="rounded-none">
      <div className="lg:flex sm:hidden mx-20 mt-24 max-md:flex-col">
        <div className="flex flex-col w-6/12 pr-36 max-md:ml-0 max-md:w-full">
          <img
            loading="lazy"
            src="hr_design_three_images/image 5.jpg"
        ...
        <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
          ...
          Simplify and Enhance Internal Communication
      </h1>
      <div className="z-10 mt-4 max-md:mt-10 max-md:max-w-full">
        <p className="text-lg font-interregular">Say goodbye to miscommunication and welcome a streamlined approach to keeping everyone on the same page:</p>
      ...
      <div className="z-10 mt-2 max-md:mt-10 max-md:max-w-full">
        <p className="text-sm font-interregular">Say goodbye to miscommunication and welcome a streamlined approach to keeping everyone on the same page:</p>
        {features.map((feature, index) => (
          <div key={index} className="mb-1">
          <ul className="list-disc pl-5">
      ...
      <div className="flex gap-0 justify-between self-end mt-4 max-w-full text-xs w-[350px] max-md:mt-10">
              {HERO_BUTTONS.map((button, index) => (
                <button key={index}
                 className={`gap-2.5 self-stretch px-5 py-2 bg-sky-500 font-inter rounded-3xl text-white`}
                 tabIndex="0"
    ...
    <h1 className="lg:text-4xl sm:text-2xl text-center font-intersemibold lg:mt-40 sm:text-10"style={{
            color:'rgba(28, 81, 161, 1)'
    }}>
            Comprehensive Features to Transform Communication
    </h1>
    <Features />
    <Benefits />
      ...
      <div className="lg:flex sm:hidden gap-5 max-md:flex-col">
        ...
        <div className="flex flex-col w-[78%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col w-full items-center justify-center pr-36 text-blue-800 max-md:max-w-full">
            ...
            Take the Leap Toward Better Communication
            </div>
            <div className="mt-8 text-2xl font-interregular max-md:mr-2.5 max-md:max-w-full">
            Effective communication isn&rsquo;t just an option xit&rsquo;s a necessity for modern HR management. 
            Scholar Clone&rsquo;s Communication Tools ensure your organization thrives with streamlined workflows and happy, 
      ...
      >
       Discover the Power of Connection Today!
        ...
        <div className="lg:flex flex-col lg:w-[78%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col w-full items-center justify-center text-blue-800 max-md:max-w-full">
            <div className="text-[20px] font-ralewayextrabold max-md:max-w-full max-md:text-4xl">
            Take the Leap Toward Better Communication
            </div>
            <div className="mt-4 text-1xl font-interregular max-md:mr-2.5 max-md:max-w-full">
            Effective communication isn&rsquo;t just an option xit&rsquo;s a necessity for modern HR management. 
            Scholar Clone&rsquo;s Communication Tools ensure your organization thrives with streamlined workflows and happy, 
            well-informed employees.
            </div>
            <div className="flex lg:flex-wrap gap-10 text-white mb-10">
      <button
