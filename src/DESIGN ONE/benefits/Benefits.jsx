  ...
  return (
    <div className="flex overflow-hidden flex-col items-start px-10 pt-8 mt-20 pb-8 text-2xl font-bold bg-blue-200 max-md:px-5">
      <div className="flex flex-col max-w-full w-full">
        <div className="mx-auto text-4xl text-slate-500 max-md:mr-2.5 max-md:text-4xl text-center" style={{
        ...
        <BenefitCard
          ...
          className="w-full max-md:px-5 max-md:mt-10 max-md:max-w-full"
        />
        <BenefitCard
          title={benefitsData.studentsAndParents.title}
          benefits={benefitsData.studentsAndParents.benefits}
          className="w-full max-md:px-5 max-md:mt-10 ml-36 max-md:max-w-full"
        />
        </div>
