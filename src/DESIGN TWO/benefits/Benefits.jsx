  ...
  return (
    <div className="flex items-center justify-center">
      <div className="flex flex-col items-center justify-center pt-32 w-full max-w-screen-xl bg-white">
        <h1 className="lg:text-3xl sm:text-2xl font-lxesemibold leading-none text-center text-zinc-900 underline decoration-[rgba(34,226,127,1)] decoration-4">
        ...
        <div className="mt-26 w-full flex items-center justify-center max-md:mt-10">
          <div className="flex gap-5 flex-wrap justify-center max-md:flex-col">
