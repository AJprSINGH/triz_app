...
const HERO_BUTTONS = [
    { text: "Engage Your Workforce Better! " },
    { text: "Request a Demo" }
  ];
  const featureData = [
    {
  ...
  const features = [
    {
      title: "•	📖 Centralized Company Policies",
      description: "Consolidate guidelines, procedures, and standards in one easily accessible platform."
    },
    {
      title: "Customizable Content",
      description: "Tailor the handbook to include your organization's unique culture, mission, and vision."
    },
    {
      title: "Real-Time Updates",
      description: "Instantly reflect policy changes to keep everyone aligned."
    },
    // {
  ...
  const ctaButtons = [
    {
      text: "Simplify Communication Today! ",
        ...
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-[55%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-start mt-6 w-full text-2xl font-medium max-md:mt-10 max-md:max-w-full">
              ...
              Scholar Clone&rsquo;s Organization Handbook Module
              </div>
              <div className="self-stretch text-lg mt-12 text-black max-md:mt-10 max-md:max-w-full">
              From company policies to operational guidelines, ensure every team member is informed, engaged, and empowered with easy access to critical information.
              </div>
          ...
          <div className="flex flex-col ml-5 w-[45%] max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="/hr_design_three_images/image 13.png"
...
<div className="sm:flex lg:hidden overflow-hidden flex-col justify-center items-start font-inter px-16 py-10 w-full max-md:px-5 max-md:py-24 max-md:max-w-full" style={{
      ...
      <div className="-mb-6 w-full max-w-[1668px] max-md:mb-2.5 max-md:max-w-full">
        <div className="lg:flex gap-5 max-md:flex-col">
          <div className="lg:flex flex-col lg:w-[55%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-start mt-3 w-full text-1xl font-medium max-md:mt-10 max-md:max-w-full">
              ...
              <div className="self-stretch text-sm mt-3 text-black max-md:mt-10 max-md:max-w-full">
              From company policies to operational guidelines, ensure every team member is informed, engaged, and empowered with easy access to critical information.
              </div>
              <div className="flex lg:flex-wrap gap-10 mb-10 text-[11px] mt-6 max-w-full text-white w-[547px] max-md:mt-10">
                {ctaButtons.map((button, index) => (
                  <button 
                  key={index}
                  className={button.className}
    ...
    <div className="rounded-none">
      <div className="lg:flex sm:hidden mx-20 mt-24 max-md:flex-col">
        <div className="flex flex-col w-6/12 pr-36 max-md:ml-0 max-md:w-full">
          <img
            loading="lazy"
            src="hr_design_three_images/image 14.png"
        ...
        <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
          ...
          Transform How Employees Access Information
      </h1>
      <div className="z-10 mt-4 max-md:mt-10 max-md:max-w-full">
        <p className="text-lg font-interregular">The Organization Handbook Module is your digital solution to maintaining a comprehensive and up-to-date guide for your workforce.</p>
      ...
      <div className="z-10 mt-4 max-md:mt-10 max-md:max-w-full">
        <p className="text-sm font-interregular">The Organization Handbook Module is your digital solution to maintaining a comprehensive and up-to-date guide for your workforce.</p>
        {features.map((feature, index) => (
          <div key={index} className="mb-1">
          <ul className="list-disc pl-5">
    ...
    <h1 className="lg:text-4xl sm:text-2xl text-center font-intersemibold lg:mt-40 sm:mt-10"style={{
            ...
            Features That Redefine Employee Engagement
    </h1>
    <Features />
    <Benefits />
    <div className="rounded-none lg:mx-40 sm:mx-10 lg:mt-20 ">
      <div className="lg:flex sm:hidden gap-5 max-md:flex-col">
        ...
        <div className="flex flex-col w-[78%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col w-full items-center justify-center pr-36 text-blue-800 max-md:max-w-full">
            ...
            Scholar Clone&rsquo;s Organization Handbook Module bridges the gap between policy and practice, 
            making your organization more agile, transparent, and efficient.
            </div>
