...
export default function Benefits() {
  return (<>
    ...
    >
      ...
      <div className="flex flex-wrap max-w-full w-full items-center justify-center mt-7">
        ...
        <div className="my-auto text-center justify-center text-3xl font-inter"style={{
          ...
          Benefits of AI-Driven Fee Prediction
        </div>
      </div>
        ...
        <div className="flex flex-wrap gap-5 justify-center">
          ...
          <div className="flex flex-col w-2/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Improve Financial Planning</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Stay ahead of your school&apos;s financial needs with accurate income forecasts.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Enhance Cash Flow Management</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Use predictions to align expenditures with incoming fees, ensuring financial stability.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Boost Stakeholder Confidence</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Present data-backed insights to board members and stakeholders for informed discussions.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              Let AI do the heavy lifting, eliminating manual analysis and reducing errors.
              </div>
              {/* <img
                loading="lazy"
    ...
    >
      {/* Title and Image */}
      <div className="lg:flex flex-wrap max-w-full w-full items-center justify-center mt-7">
        {/* <img
          loading="lazy"
          src="https://cdn.builder.io/api/v1/image/assets/TEMP/4a01d2ff03122fcb4356ad5aa57d62ccd3614043e31b1884e14d1b249ce38cc8?placeholderIfAbsent=true&apiKey=af5cfb29bb594d4e9f9e505ea3916323"
          className="object-contain shrink-0 w-40 self-start max-w-full aspect-[0.87]"
        ...
        <div className="lg:flex flex-wrap gap-5 justify-center">
          ...
          <div className="flex flex-col lg:w-2/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-center items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Improve Financial Planning</div>
              <div className="self-stretch mt-2 mr-2 ml-2 text-center text-sm leading-7 opacity-70">
              Stay ahead of your school&apos;s financial needs with accurate income forecasts.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-center items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Boost Stakeholder Confidence</div>
              <div className="self-stretch mt-2 mr-2 ml-2 tedxt-center text-sm leading-7 opacity-70">
              Present data-backed insights to board members and stakeholders for informed discussions.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-center items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Save Time and Effort</div>
              <div className="mt-2 mr-2 ml-2 text-center text-sm  opacity-70 leading-7 w-[350px]">
              Let AI do the heavy lifting, eliminating manual analysis and reducing errors.
              </div>
              {/* <img
                loading="lazy"
