...
const HERO_BUTTONS = [
  ...
  const features = [
    {
      title: "Live Counseling Sessions",
      description: "The interactive format allows real-time Q&A and tailored advice."
    },
    {
      title: "Interactive Learning Tools",
      description: "Access a variety of resources like live polls, quizzes, and breakout rooms designed to make career preparation dynamic and engaging."
    },
    {
      title: "Flexible Scheduling",
      description: "Busy schedule? No problem! Choose from multiple session timings and easily join from any device—be it your laptop, tablet, or smartphone."
    },
    {
      title: "Collaborative Environment",
      description: "Collaborate with peers, share ideas, and gain fresh perspectives through group discussions."
    },
    {
      title: "Recorded Sessions",
      description: "Every class is recorded and stored in your personal portal for future review."
    }
  ];
...
<div className="lg:flex sm:hidden overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    ...
    Step into the Future with the Virtual Classroom Module
    </h1>
    <h4 className="text-lg mt-20 font-intersemibold text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(18, 20, 29, 1)'
    }}>
    Empowering students with real-time career counseling from the comfort of their homes, the Virtual Classroom Module of Scholar Clone&rsquo;s Career Counseling System is the ultimate destination for interactive learning. 
    </h4>
...
>
  ...
  >
    ...
    <div className="rounded-none">
      <div className="lg:flex mx-20 lg:mt-20 sm:mt-20 gap-20 max-md:flex-col">
        <div className="flex lg:flex-col lg:w-6/12 max-md:ml-0 max-md:w-full">
          <img
            loading="lazy"
            src="cc_design_two_images/image 2.png"
        ...
        <div className="flex lg:flex-col lg:w-6/12 sm:w-full mt-10 max-md:ml-0 max-md:w-full">
          ...
          Key Features of the Virtual Classroom
      </h1>
    ...
    Join the Virtual Classroom and <br/>Build Your Future
    </h1>
