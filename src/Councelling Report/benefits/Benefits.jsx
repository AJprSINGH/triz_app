        ...
        <div className="flex flex-wrap gap-5 justify-center">
          ...
          <div className="flex flex-col w-2/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Enhance Student Success</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Equip students with the tools to make informed decisions about their futures.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Build Confidence</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Help students feel empowered to pursue their passions with a clear plan.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Support Parents</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Offer them visibility into their child&rsquo;s strengths and career options.
              </div>
            </div>
          </div>
