  ...
  const features = [
    {
      ...
      description: "The module evaluates students' strengths, preferences, and abilities using proven frameworks like the RIASEC model (Realistic, Investigative, Artistic, Social, Enterprising, Conventional)."
    },
    {
      title: "Vendor & Purchase Orders",
      description: "Students receive tailored recommendations based on their assessment results. "
    },
    {
      title: "Stock In/Out Logs",
      description: "Dive deeper into career options with an interactive exploration hub that offers"
    },
    // {
        ...
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-[55%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-start mt-6 w-full text-2xl font-medium max-md:mt-10 max-md:max-w-full">
              ...
              Discover the Perfect Career Path with the Counseling Report Module
              </div>
              <div className="self-stretch text-lg mt-12 text-black max-md:mt-10 max-md:max-w-full">
              Navigating career choices can be overwhelming, but the Counseling Report Module simplifies this process by turning test assessments into clear, actionable insights. 
              </div>
          ...
          <div className="flex flex-col ml-5 w-[45%] max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="/cc_design_three_images/image 4.png"
...
<div className="sm:flex lg:hidden overflow-hidden flex-col justify-center items-start font-inter px-16 py-10 w-full max-md:px-5 max-md:py-24 max-md:max-w-full" style={{
        ...
        <div className="lg:flex gap-5 max-md:flex-col">
          <div className="flex flex-col lg:w-[55%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-start mt-6 w-full text-1xl font-medium max-md:mt-10 max-md:max-w-full">
              ...
              <div className="flex lg:flex-wrap gap-10 text-[11px] mt-6 max-w-full mb-3 text-white w-[547px] max-md:mt-10">
                {ctaButtons.map((button, index) => (
                  <button 
                  key={index}
                  className={button.className}
          ...
          <div className="flex flex-col ml-5 lg:w-[45%] max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="/cc_design_three_images/image 4.png"
              alt="User and teacher management interface demonstration"
    ...
    <div className="rounded-none">
      <div className="lg:flex sm:hidden mx-20 mt-24 max-md:flex-col">
        <div className="flex flex-col w-6/12 pr-36 max-md:ml-0 max-md:w-full">
          <img
            loading="lazy"
            src="cc_design_three_images/image 5.jpeg"
      ...
      <div className="sm:flex lg:hiddem mx-10 mt-12 max-md:flex-col">
    ...
    <h1 className="lg:text-4xl sm:text-2xl text-center font-intersemibold lg:mt-40 sm:mt-10"style={{
            ...
            Comprehensive Features to Streamline Operations
    </h1>
    <Features />
    <Benefits />
    <div className="rounded-none lg:mx-40 sm:mx-10 lg:mt-20">
      <div className="lg:flex sm:hidden gap-5 max-md:flex-col">
        ...
        <div className="flex flex-col w-[78%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col w-full items-center justify-center pr-36 text-blue-800 max-md:max-w-full">
            ...
            The Counseling Report Module ensures every student can confidently pursue their dreams, fully informed <br/>and prepared. 
            </div>
      ...
      >
        ...
        <div className="sm:flex lg:hidden gap-5 max-md:flex-col mb-10">
