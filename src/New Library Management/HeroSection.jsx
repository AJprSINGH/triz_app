  ...
  const features = [
    {
      ...
      description: "Keep tabs on your library resources anytime, anywhere, with real-time inventory tracking for books, e-resources, and more."
    },
    {
      title: "Effortless Borrowing & Returns",
      description: "Simplify issue and return processes with automated tracking and notifications, eliminating manual errors."
    },
    {
      title: "Empower Knowledge Sharing",
      description: "Enable easy access to e-books and digital resources, fostering a tech-savvy learning environment."
    },
    // {
