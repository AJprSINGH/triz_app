    ...
    >
      ...
      <div className="flex flex-wrap max-w-full w-full items-center justify-center mt-7">
        ...
        <div className="my-auto text-center justify-center text-3xl font-inter"style={{
          ...
          Benefits of Our Library Management Module
        </div>
      </div>
        ...
        <div className="flex flex-wrap gap-5 justify-center">
          ...
          <div className="flex flex-col w-2/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              Automate routine tasks like cataloging, borrowing, and reporting for maximum efficiency.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none"> Reduce Costs</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Avoid duplicate purchases and maximize resource utilization with a centralized database.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Promote Learning</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Enhance access to knowledge with an organized library system that supports both physical and digital resources.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Ensure Transparency</div>
              <div className="mt-4 text-sm  opacity-70 leading-7 w-[350px]">
              Maintain clear audit trails for every transaction, ensuring accountability at every level.
              </div>
              {/* <img
                loading="lazy"
