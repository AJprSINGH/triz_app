...
export default function Benefits() {
 ...
    </div>
 <div className="sm:flex lg:hidden flex-col pb-5 h-[155vh] bg-white overflow-hidden shadow-[0px_3px_8px_rgba(0,0,0,0.25)] max-md:pl-5">
      ...
      <div className="flex justify-center items-center mt-6 mx-14">
