...
<div className="lg:flex sm:hidden overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white text-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    ...
    Welcome to the Future of SQAA with Scholar Clone
    </h1>
    <h4 className="text-lg mt-6 font-intersemibold text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(34, 69, 111, 1)'
    }}>
Designed exclusively for CBSE schools, the Scholar Clone SQAA Module is your ultimate partner in transforming school 
quality and streamlining the accreditation process. With a focus on efficiency, compliance, and innovation, this module 
ensures your school meets CBSE SQAA standards while empowering educators to deliver excellence in education.    </h4>
...
<div className="sm:flex lg:hidden overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-4 max-w-full h-full bg-white text-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    ...
    <h4 className="text-sm mt-3 mr-2 ml-3 font-intersemibold text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(34, 69, 111, 1)'
    }}>
Designed exclusively for CBSE schools, the Scholar Clone SQAA Module is your ultimate partner in transforming school 
quality and streamlining the accreditation process. With a focus on efficiency, compliance, and innovation, this module 
...
>
  Get Started Today
      ...
      <div className="lg:flex sm:hidden gap-5 max-md:flex-col">
          ...
          <div className="flex flex-col grow mt-14 text-2xl text-slate-800 max-md:mt-10 max-md:max-w-full">
            <div className="flex flex-col items-start self-end mt-24 px-20 max-w-full w-[733px]">
              <div className="text-2xl font-inter text-sky-800 max-md:max-w-full">
                Effortless Quality Assessment Process
              </div>
              <div className="mt-5 text-lg font-interregular leading-6 w-[571px] max-md:max-w-full">
              Navigating the CBSE SQAA framework has never been easier. The Scholar Clone SQAA Module provides 
              an intuitive, automated process that eliminates complexity and saves valuable time.
              </div>
              <div className="mt-8 text-lg leading-6 w-[601px] max-md:max-w-full">
              •	Simplify assessment submissions.<br/>
              •	Achieve compliance with minimal effort.<br/>
              •	Focus on delivering exceptional learning outcomes.
        ...
        <div className="flex flex-col lg:-ml-20 lg:pr-34 w-[43%] max-md:ml-0 max-md:w-full">
          <div className=" builder-canvas flex relative flex-col pt-12 max-w-[707px] min-h-[590px] max-md:pr-5 max-md:mt-10 max-md:max-w-full">
            ...
            <img
              loading="lazy"
              src="/Design_five_images/image 2.png"
      ...
      <div className="w-full max-w-[1541px] max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-2/5 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="/Design_five_images/image 90.png"
          ...
          <div className="flex flex-col ml-5 w-3/5 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col self-stretch my-auto w-full max-md:mt-10 max-md:max-w-full">
              ...
              Seamlessly integrate and align your school&rsquo;s operations with the CBSE SQAA framework<br/> Our module digitizes the 
              entire process,
               breaking it into manageable benchmarks for effortless compliance:
              </div>
    ...
    <div className="flex flex-col items-end px-8 pt-7 pb-12 max-md:px-5">
      <div className="w-full max-w-[1541px] max-md:max-w-full">
        <div className="lg:flex gap-5 max-md:flex-col">
          ...
          <div className="flex flex-col ml-2 lg:w-3/5 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col self-stretch my-auto w-full max-md:mt-10 max-md:max-w-full">
              <div className="text-3xl font-inter tracking-tighter text-sky-800 max-md:max-w-full">
                Comprehensive Framework Alignment
              </div>
    ...
    <Benefits />
    <h1 className="lg:text-3xl sm:text-3xl lg:mt-40 sm:mt-20 font-ralewaysemibold text-center max-md:max-w-full max-md:text-4xl"style={{
        color:'rgba(21, 70, 120, 1)'
    }}>
    See Scholar Clone SQAA in Action
    </h1>
    <h4 className="lg:text-4xl sm:text-2xl mt-4 font-quicksandbold text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(21, 70, 120, 1)'
    }}>
    Are you ready to revolutionize your school&rsquo;s SQAA journey and set new standards in education quality? Explore 
    the transformative power of the Scholar Clone SQAA Module today.
    </h4>
