...
<div className="lg:flex sm:hidden overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white text-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    ...
    Experience the power of integration with our Tally and Payment Gateway module, designed to streamline your financial operations. Say goodbye to manual processes and hello to automated efficiency. Transform your ERP experience today!
    </h4>
...
<div className="sm:flex lg:hidden overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-10 max-w-full h-full bg-white text-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    ...
    <h4 className="text-sm mt-8 font-intersemibold text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(34, 69, 111, 1)'
    }}>
    Experience the power of integration with our Tally and Payment Gateway module, designed to streamline your financial operations. Say goodbye to manual processes and hello to automated efficiency. Transform your ERP experience today!
    </h4>
...
The Tally and Payment Gateway Integration module connects Tally accounting software with popular payment gateways like PayPal, Stripe, and Razorpay. This integration streamlines payment processing by eliminating manual data entry, reducing errors, and enabling real-time transaction management. It enhances operational efficiency and boosts customer satisfaction.
            </div>
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white text-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    ...
    With this module, businesses can generate payment links directly from Tally invoices, making it easier for customers to complete transactions. The integration allows for automatic reconciliation of payments, ensuring that your financial records are always accurate and up-to-date. Experience a unified approach to managing your finances—where every transaction is just a click away. 
    </h4>
  ...
  >
  <div className="flex overflow-hidden flex-col lg:pt-20 sm:pt-10 max-w-full h-full bg-white text-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    <h1 className="lg:text-2xl sm:text-1xl lg:text-1xl font-inter text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(34, 69, 111, 1)'
    }}>
    A Unified Approach to Financial Management
    </h1>
    <h4 className="text-[12px] mr-3 ml-3 mt-10 font-inter text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgb(0, 0, 0)'
    }}>
    With this module, businesses can generate payment links directly from Tally invoices, making it easier for customers to complete transactions. The integration allows for automatic reconciliation of payments, ensuring that your financial records are always accurate and up-to-date. Experience a unified approach to managing your finances—where every transaction is just a click away. 
    </h4>
    ...
    Experience the unparalleled convenience of the Tally & Payment Gateway Integration Module today. Let us help you revolutionize your payment and accounting processes!
