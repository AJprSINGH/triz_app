...
const features = [
  {
    ...
    title: "Smart Skill Matrix",
    description:
      "Visualize your workforce&apso;s strengths with an interactive matrix that connects individual skills to team and departmental needs.",
  },
  {
    ...
    title: "Customizable Skill Benchmarks",
    description:
      "Set specific benchmarks for roles and track how employees measure up against them.",
  },
  {
    ...
    description:
      "Access live reports on skill distribution, proficiency levels, and progress across the organization.",
  },
  {
    ...
    description:
      "Integrates with your HRMS and other modules like Performance Reviews, Succession Planning, and Training Management for a unified approach..",
  },
  {
    ...
    description:
      "View and update skill profiles on the go with mobile-responsive dashboards.",
  },
  {
    ...
    title: "Role Alignment & Optimization",
    description:
      "Align employees with roles that match their strengths while helping them grow into new opportunities.",
  },
];
