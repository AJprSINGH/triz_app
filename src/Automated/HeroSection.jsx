...
<div className="flex overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white bg-opacity-0 w-full px-40 max-md:px-5 max-md:pb-24">
    ...
    Simplify Communication, Build Connections
    </h1>
...
Effective communication is the backbone of every successful school. The Automated Communication Module from Scholar Clone
 ERP empowers your school to deliver timely and personalized messages with ease. Whether it&rsquo;s IVRS-based interactions, 
 greetings, or automated reminders for fees, admissions, or book returns, this module ensures that your communication is 
 seamless, professional, and impactful. <br/>Say goodbye to manual follow-ups and repetitive tasks. With automation, your school can save time, reduce errors, and 
  enhance engagement with parents, students, and staff.  </h4>
...
>
  Get Started Today
    ...
    Why Is Automated Communication Essential for Your School?
    </h1>
          ...
          <div className="flex flex-col grow mt-20 text-2xl text-slate-800 max-md:mt-10 max-md:max-w-full">
            <div className="flex flex-col items-start self-end px-20 max-w-full w-[733px]">
              ...
              Manually managing communication can lead to:<br/>
                ...
                •	Inconsistent Communication: Irregular or delayed updates that create frustration.<br/>
              The Automated Communication Module ensures all your messages reach the right audience at the right time, 
   ...
   Key Features of the Automated Communication Module
    </h1>
    <div className="flex overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
      ...
      <div className="w-[1200px] max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          ...
          <div className="flex overflow-hidden flex-col pt-10 pr-16 pb-16 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              Send warm, automated greetings to students and staff.
              Tailor messages for events like school anniversaries or academic milestones.
              </div>
            </div>
          </div>
          <div className="flex flex-col ml-5 w-[33%] max-md:ml-0 max-md:w-full">
      ...
      <div className="self-center mt-12 ml-44 max-w-full w-[1000px] max-md:mt-10">
        <div className="flex gap-5 max-md:flex-col">
          ...
          <div className="flex overflow-hidden flex-col pt-10 pr-20 pb-16 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              <div className="mt-8 text-sm text-zinc-600">
              Leverage IVRS to connect with parents or staff instantly.
              Update reminders and alerts directly on the parent portal for easy access.
              </div>
            </div>
          </div>
          ...
          <div className="flex overflow-hidden flex-col pt-10 pr-16 pb-16 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              <div className="mt-8 text-sm text-zinc-600">
              Send specific messages to parents, students, staff, or vendors based on roles.
              Plan and schedule reminders, greetings, or announcements in advance.
              </div>
            </div>
          </div>
        </div>
    ...
    <h1 className="text-center text-3xl font-inter mt-20" style={{
      ...
      Benefits of the Automated Communication Module
    </h1>
    <Benefits />
...
From managing fee reminders to sending greetings and following up on admissions, the Automated Communication Module 
does it all. Improve your school&rsquo;s efficiency, build better relationships, and ensure no important message is 
ever missed.    </h4>
