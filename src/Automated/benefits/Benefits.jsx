...
const features = [
  {
    title: "Save Time ",
    description: "Eliminate repetitive manual tasks by automating routine communications."
  },
  {
    title: "Improve Engagement",
    description: "Keep parents informed and connected with timely updates and personalized messages."
  },
  {
    title: "Reduce Errors",
    description: "Ensure every message is accurate and delivered to the right audience."
  },
  {
    title: "Boost Efficiency",
    description: "Handle large-scale communication effortlessly using IVRS, bulk SMS, and email tools."
  }
];
