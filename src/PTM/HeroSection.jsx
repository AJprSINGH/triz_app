  ...
  const featureData = [
    {
      ...
      description: "Let teachers focus on building meaningful relationships with parents while we handle the scheduling and reminders."
    },
    {
      title: "Engage Parents",
      description: "Make parents feel valued with timely notifications, clear communication, and a seamless meeting experience.."
    },
    {
      title: "Support Students",
      description: "Strengthen the bond between home and school to foster better student outcomes."
    }
  ];
  const features = [
    {
      title: "Hassle-Free Scheduling",
      description: "Say goodbye to scheduling headaches! Teachers can create customized meeting slots with just a few clicks. Whether it’s individual or group meetings, we’ve got you covered."
    },
    {
      title: "Instant Parent Notifications",
      description: "Let parents know the moment a meeting is scheduled. Automated notifications via SMS, WhatsApp, or email ensure they never miss an update."
    },
    {
      title: "Real-Time Syncing",
      description: "With our smart integrated calendar, you’ll avoid scheduling conflicts and maintain a stress-free PTM experience."
    },
    {
      title: "Post-Meeting Insights",
      description: "Receive valuable feedback after every meeting to improve teacher-parent engagement and take actionable steps for student success."
    },
    {
      title: "Attendance & Accountability",
      description: "Track parent participation effortlessly and maintain a record of meetings for better accountability and future reference."
    }
  ];
...
<div className="lg:flex sm:hidden overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    ...
    Transform the Way You Conduct Parent-Teacher Meetings
    </h1>
    <h4 className="text-lg mt-20 font-intersemibold text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(18, 20, 29, 1)'
    }}>
   Seamlessly manage your school’s Parent-Teacher Meetings (PTM) with Scholar Clone’s PTM Management System. Eliminate the chaos of manual scheduling and empower your teachers and parents with a streamlined, automated solution.
    </h4>
...
>
Get Started Today – Simplify Your PTM Process!
</button>
</div>
  </div>
    </div>
<div className="sm:flex lg:hidden overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    ...
    <h4 className="text-sm mt-6 ml-2 font-intersemibold text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(18, 20, 29, 1)'
    }}>
   Seamlessly manage your school’s Parent-Teacher Meetings (PTM) with Scholar Clone’s PTM Management System. Eliminate the chaos of manual scheduling and empower your teachers and parents with a streamlined, automated solution.
    </h4>
...
Get Started Today – Simplify Your PTM Process!
  ...
  >
    <div className="flex flex-col rounded-lg mx-40">
      ...
      The Ultimate PTM Solution – Built for Schools Like Yours
      </div>
        ...
        <div className="flex gap-5 max-md:flex-col">
          {featureData.map((feature, index) => (
            ...
            <div className="flex overflow-hidden flex-col grow px-10 pt-8 pb-6 w-full tracking-tighter leading-9 text-center text-black bg-white rounded-lg max-md:px-5 max-md:mt-10">
              <div className="text-xl font-lxsemibold max-md:mr-1.5">
                {feature.title}
              </div>
              <div className="mt-2 text-[12px] font-interregular">
                {feature.description}
              </div>
            </div>
          </div>
  ...
  >
    <div className="lg:flex flex-col rounded-lg mx-40">
      <div className="z-10 self-center ml-6 text-lg mt-4 font-lxsemibold tracking-tighter leading-none text-center text-white max-md:max-w-full underline decoration-[rgba(34,226,127,1)] decoration-4">
      The Ultimate PTM Solution – Built for Schools Like Yours
      </div>
      <div className="mt-14 w-full max-md:mt-10 max-md:max-w-full">
        <div className="lg:flex gap-5 max-md:flex-col">
          {featureData.map((feature, index) => (
            ...
            <div className="flex overflow-hidden flex-col grow px-10 pt-8 pb-6 w-full tracking-tighter leading-9 text-center text-black bg-white rounded-lg max-md:px-5 max-md:mt-10">
              ...
              <div className="mt-2 text-[12px] font-interregular" style={{lineHeight:1.0}}>
                {feature.description}
              </div>
            </div>
          </div>
    ...
    <div className="rounded-none">
      <div className="lg:flex mx-20 mt-20 gap-20 max-md:flex-col">
        <div className="flex lg:flex-col lg:w-6/12 max-md:ml-0 max-md:w-full">
          <img
            loading="lazy"
            src="Design_two_images/image 1.webp"
        ...
        <div className="flex flex-col lG:w-6/12 mt-10 max-md:ml-0 max-md:w-full">
          ...
          Why Choose Our PTM Management System?
      </h1>
    ...
    Ready to Transform Your<br></br> PTM Experience?
    </h1>
...
<button 
  ...
  aria-label="Book Your Demo Now"
>
Transform Your School’s PTM Process Now →
</button>
</div>
<Footer />
  </>
