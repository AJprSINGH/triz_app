...
const features = [
  {
    title: "Personalized Support for Students: ",
    description: "Help students make informed choices about their careers and education paths."
  },
  {
    title: "Increase Enrollment Success: ",
    description: "Improve competitive exam results and scholarship access for better admission outcomes."
  },
  {
    title: "Reputation Building:",
    description: " Showcase your institution as a leader in student guidance and success."
  },
  {
    title: "Compliance: ",
    ...
    <div className="rounded-none">
      <div className="flex mx-20 mt-20 max-md:flex-col">
          <div className="flex flex-col w-6/12 ml-10 -mr-32 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="cc_design_four_images/image 2.png"
