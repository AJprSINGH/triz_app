...
function ContactInfo() {
  ...
  return (
    <div className="flex flex-col ml-10 w-[44%] max-md:ml-0 max-md:w-full">
  <div className="flex relative flex-col px-20 py-36 w-full rounded-xl max-h-[550px] max-md:px-5 max-md:py-20 max-md:mt-4 max-md:max-w-full">
    ...
    <div className="flex relative gap-9 self-start mt-6 ml-0 text-xl text-center text-white whitespace-nowrap max-md:mt-4 max-md:ml-2.5">
      <img src={socialIcons[0]} alt="Social Icons" className="w-full" /> {/* Adjust size as needed */}
    </div>
  </div>
</div>
  );
