      ...
      <div className="sm:block lg:hidden gap-5 max-md:flex-col">
        <div className="w-full max-md:ml-0 max-md:w-full">
          <div className="z-10 mr-0 w-full max-md:max-w-full">
            ...
            <div className="mt-0 max-md:mt-10 max-md:max-w-full">
              <div className="items-center justify-center max-md:flex-col">
                <div className="mt-20 max-md:ml-0 mx-10">
                  <div className="flex flex-col items-start my-auto w-full text-xl font-medium text-black max-md:mt-10 max-md:max-w-full">
                    <div className="text-xl font-inter text-amber-500 max-md:max-w-full">
                      Your Students&rsquo; Journey to Success Begins Here
                    </div>
                    <div className="text-[15px] text-justify font-interregular mt-6  max-md:mt-10 max-md:max-w-full">
                      Scholar Clone equips students with the tools they need to
                      navigate their career paths confidently. By integrating
                      advanced career counseling modules, the platform ensures
                      students are prepared for the dynamic demands of the
                    ...
                    <div className="flex gap-4 mt-6 max-md:mt-10">
                      <img
                        ...
                        className="object-contain shrink-0 w-8 aspect-square"
                      />
                      <div className="flex-auto font-intermedium text-[15px] self-start max-md:max-w-full">
                        RIASEC Profiling for Personalized Career Suggestions
                      </div>
                    </div>
                    <div className="flex  gap-4 mt-2">
                    ...
                    <div className="flex gap-4 mt-2">
                      <img
                        ...
                        className="object-contain shrink-0 w-8 aspect-square"
                      />
                      <div className="flex-auto font-intermedium text-[15px] self-start">
                        Mock Interviews and CV Builders
                      </div>
                    </div>
                  </div>
