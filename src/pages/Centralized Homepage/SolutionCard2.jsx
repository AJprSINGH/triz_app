      ...
      <div className="flex gap-5 max-md:flex-col">
        <div className="flex flex-col w-[32%] max-md:ml-0 max-md:w-full">
          <img
            ...
            className="box-border object-cover overflow-hidden shrink-0 mt-4 ml-6 w-full aspect-square max-w-[479px] min-h-[20px] min-w-[20px]"
          />
        </div>
        <div className="flex flex-col ml-5 w-[68%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col mt-4 w-full max-md:mt-10 max-md:max-w-full">
            <div className="self-start mt-1.5 text-2xl font-bold text-black">
              Solution For K-12
            </div>
            <div className="mt-10 text-xl font-bold text-black max-md:max-w-full">
              ...
              schools to inspire success, streamline operations, and shape
              bright futures.
            </div>
              ...
              <div className="flex gap-5 max-md:flex-col">
                <div className="flex flex-col w-[26%] max-md:ml-0 max-md:w-full">
                  <a
                    ...
                    className="box-border relative shrink-0 px-6 py-4 mt-5 text-center bg-green-700 rounded shadow-sm appearance-none cursor-pointer text-[white]"
                    target="_blank"
