  ...
  return (
    <div className="flex flex-col sm:w-[80%] md:w-[36%] lg:w-[30%] mb-6 sm:mb-3 items-center">
      <div className="flex flex-col justify-center items-center p-4 sm:p-2 md:p-6">
        <div className="flex justify-center items-center p-4 sm:p-2 bg-sky-500 lg:w-[200px] sm:w-[150px] rounded-full shadow-lg">
          <img loading="lazy" src={imageSrc} alt={title} className="object-contain lg:w-[120px] sm:w-[70px] md:w-[100px]" />
        </div>
      </div>
