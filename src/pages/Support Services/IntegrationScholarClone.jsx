          ...
          <div className="flex gap-4 max-md:flex-col">
            <div className="flex flex-col w-full lg:w-6/12 max-md:ml-0 max-md:w-full">
              <div className="flex flex-col mt-6 w-full max-md:max-w-full">
                <h1 className="mr-10 ml-5 text-3xl font-bold text-sky-500 max-md:mr-2.5 max-md:max-w-full max-md:text-4xl">
            ...
            <div className="flex flex-col ml-20 w-full lg:w-6/12 max-md:ml-0 max-md:w-full">
              <img loading="lazy" src="/supportservice_images/image.png" />
            </div>
          </div>
        </section>
        <Services />
