  ...
  const features = [
    {
      ...
      description: "Pinpoint your passions with our tailored Interest Profile Assessment."
    },
    {
      title: "Vendor & Purchase Orders",
      description: "Understand how you interact, make decisions, and process information."
    },
    {
      title: "Stock In/Out Logs",
      description: "Connect with experienced career counselors for a personalized, in-depth session."
    },
    // {
...
<div className="flex overflow-hidden flex-col justify-center items-start font-inter px-16 py-10 w-full max-md:px-5 max-md:py-24 max-md:max-w-full" style={{
        ...
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-[55%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-start mt-6 w-full text-2xl font-medium max-md:mt-10 max-md:max-w-full">
              ...
              Discover Your True Potential with the Know Yourself Module
              </div>
              <div className="self-stretch text-lg mt-12 text-black max-md:mt-10 max-md:max-w-full">
               This comprehensive career counseling solution helps you uncover your true potential, guiding you toward the best career choices that align with who you are.
              </div>
          ...
          <div className="flex flex-col ml-5 w-[45%] max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="/cc_design_three_images/image 1.png"
    ...
    <div className="rounded-none">
      <div className="flex mx-20 mt-24 max-md:flex-col">
        <div className="flex flex-col w-6/12 pr-36 max-md:ml-0 max-md:w-full">
          <img
            loading="lazy"
            src="cc_design_three_images/image 2.jpeg"
        ...
        <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
          ...
          Simplify Self-Discovery with These Four Features
      </h1>
      <div className="z-10 mt-4 max-md:mt-10 max-md:max-w-full">
        <p className="text-lg font-interregular">The Know Yourself Module is designed to help students and professionals understand themselves better through scientifically-backed tools and expert counseling.</p>
    ...
    <h1 className="text-4xl text-center font-intersemibold mt-40"style={{
            ...
            Comprehensive Features to Help You Know Yourself
    </h1>
    <Features />
    <Benefits />
      ...
      <div className="flex gap-5 max-md:flex-col">
        ...
        <div className="flex flex-col w-[78%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col w-full items-center justify-center pr-36 text-blue-800 max-md:max-w-full">
            ...
            Take the First Step to Know Yourself Today!
            </div>
            <div className="mt-8 text-2xl font-interregular max-md:mr-2.5 max-md:max-w-full">
            From scientifically-backed assessments to expert counseling, we make self-discovery easy and empowering.
            </div>
