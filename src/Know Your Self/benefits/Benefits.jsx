        ...
        <div className="flex flex-wrap gap-5 justify-center">
          ...
          <div className="flex flex-col w-2/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Self-Awareness</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Your interests setting the foundation for informed decisions about your future.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Tailored Career Paths</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Find the careers that best match your unique profile, ensuring a fulfilling and purpose-driven professional journey.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Expert Guidance</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Leverage the knowledge and experience of trained counselors to navigate complex career choices with ease.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Convenience and Accessibility</div>
              <div className="mt-4 text-sm  opacity-70 leading-7 w-[350px]">
              With options for both in-person and virtual counseling, you&rsquo;ll have the flexibility to discover yourself on your terms.
              </div>
              {/* <img
                loading="lazy"
