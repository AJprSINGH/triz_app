...
const features = [
  {
    ...
    description: "Empower employees to grow their skills and feel valued in their roles"
  },
  {
    title: "Better Retention Rates: ",
    description: "Employees are more likely to stay with organizations that invest in their development."
  },
  {
    title: "Enhanced Productivity: ",
    description: "Boost team efficiency by equipping employees with up-to-date skills and knowledge."
  },
  {
    title: "Compliance Made Easy: ",
    description: "Ensure your workforce meets all necessary industry certifications and standards.."
  }
];
    ...
    <div className="rounded-none">
      <div className="flex mx-20 mt-20 max-md:flex-col">
          <div className="flex flex-col w-6/12 ml-10 -mr-32 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="hr_design_four_images/image 4.png"
