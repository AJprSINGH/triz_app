    ...
    >
      ...
      <div className="flex flex-wrap max-w-full w-full items-center justify-center mt-7">
        ...
        <div className="my-auto text-center justify-center text-3xl font-inter"style={{
          ...
          Benefits of the Student Support & Engagement Module
        </div>
      </div>
        ...
        <div className="flex flex-wrap gap-5 justify-center">
          ...
          <div className="flex flex-col w-2/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">For Students</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Stay motivated with clear goals, rewards, and accessible support.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">For Educators</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Identify struggling students early and provide targeted interventions.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Administrators</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
             Gain valuable insights into overall student engagement and well-being.
              </div>
            </div>
          </div>
