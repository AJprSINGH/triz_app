...
const features = [
  {
    ...
    description: "Access tailored resources and guidance based on individual student performance.",
  },
  {
    icon: "bg-violet-300",
    title: "Real-Time Communication",
    description: "Built-in chat features for students to connect with teachers or peers.",
  },
  {
    icon: "bg-green-300",
    title: "Progress Tracking",
    description: "Real-time performance insights help educators identify and address learning gaps quickly.",
  },
];
  ...
  return (
    <div className="lg:flex lg:mx-20 sm:mx-10 lg:mt-24 sm:mt-12 max-md:flex-col lg:mb-24 sm:mb-12">
      <div className="flex flex-col lg:w-[60%] lg:pr-20 max-md:ml-0 max-md:w-full">
          <img
            loading="lazy"
            src="lms_design_three_images/image 12.jpg"
