...
const features = [
  {
    ...
    description: "Prepare your leaders for future challenges with structured development programs."
  },
  {
    title: "Improved Team Productivity:",
    description: " Foster collaboration and cohesion within and across teams."
  },
  {
    title: "Higher Employee Retention: ",
    description: "Invest in employee growth to boost morale and reduce turnover."
  },
  {
    title: "Better Alignment with Goals:",
    description: " Ensure all levels of your workforce align with organizational vision and objectives."
  }
];
    ...
    <div className="rounded-none">
      <div className="flex mx-20 mt-20 max-md:flex-col">
          <div className="flex flex-col w-6/12 ml-10 -mr-32 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="hr_design_four_images/image 6.png"
