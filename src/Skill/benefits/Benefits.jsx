  ...
  return (<>
        ...
        <div className="flex flex-wrap gap-5 justify-center">
          ...
          <div className="flex flex-col w-2/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">STEM Mastery</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Students can dive into coding, robotics, and engineering fundamentals using step-by-step 
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Creative Arts Development</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              From digital painting tutorials to creative writing guides, the Skill Library empowers students 
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Leadership and Life Skills</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Courses on leadership, teamwork, financial literacy, and emotional intelligence ensure students 
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Language and Communication Excellence</div>
              <div className="mt-4 text-sm  opacity-70 leading-7 w-[350px]">
              Boost language skills with grammar exercises, public speaking workshops
              </div>
              {/* <img
                loading="lazy"
    ...
    >
      ...
      <div className="flex justify-center items-center mt-10 w-full max-w-screen-xl">
        <div className="flex flex-wrap gap-5 justify-center">
          {/* First Benefit */}
          <div className="lg:flex flex-col w-12/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-center items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">STEM Mastery</div>
              <div className="self-stretch mt-2 text-sm mr-2 ml-2 text-center leading-7 opacity-70">
              Students can dive into coding, robotics, and engineering fundamentals using step-by-step 
              </div>
            </div>
          </div>
          ...
          {/* Second Benefit */}
          <div className="flex flex-col w-12/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-center items-start text-zinc-900 max-md:mt-10">
              <img
                loading="lazy"
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/c8b25abdb6a05b130ca8fe2212057b446dbe4738c1db769c2cf80aaf22b6a585?placeholderIfAbsent=true&apiKey=af5cfb29bb594d4e9f9e505ea3916323"
          ...
          <div className="flex flex-col w-12/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-center items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Language and Communication Excellence</div>
              <div className="mt-2 mr-2 ml-3 text-center text-sm  opacity-70 leading-7 w-[350px]">
              Boost language skills with grammar exercises, public speaking workshops
              </div>
              {/* <img
                loading="lazy"
