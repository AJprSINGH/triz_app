...
const features = [
  {
    ...
    description: "Graduates will design and develop innovative solutions for real-world engineering problems.",
  },
  {
    icon: "bg-violet-300",
    title: "Business Programs",
    description: "Graduates will apply analytical and leadership skills to drive organizational success.",
  },
  {
    icon: "bg-green-300",
    title: "Medical Programs:",
    description: "Graduates will demonstrate clinical expertise and ethical decision-making in patient care.",
  },
];
  ...
  return (
    <div className="lg:flex lg:mx-20 sm:mx-10 lg:mt-24 sm:mt-12 max-md:flex-col lg:mb-24 sm:mb-12">
      <div className="flex flex-col lg:w-[60%] lg:pr-20 max-md:ml-0 max-md:w-full">
          <img
            loading="lazy"
            src="lms_design_three_images/image 3.jpg"
