...
export default function Benefits() {
  return (<>
    ...
    >
      ...
      <div className="flex flex-wrap max-w-full w-full items-center justify-center mt-7">
        ...
        <div className="my-auto text-center justify-center text-3xl font-inter"style={{
          ...
          Benefits of Well-Defined Program Objectives
        </div>
      </div>
        ...
        <div className="flex flex-wrap gap-5 justify-center">
          ...
          <div className="flex flex-col w-2/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Consistency</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Aligns course content and learning activities across the program.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Future Readiness</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Prepares students for career demands or advanced studies.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Mathematics Course</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              	Understand and apply statistical methods to analyze real-world data.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Literature Course</div>
              <div className="mt-4 text-sm  opacity-70 leading-7 w-[350px]">
              Analyze literary themes across various genres and historical periods.
              </div>
              {/* <img
                loading="lazy"
    ...
    >
      ...
      {/* Benefits Section */}
      <div className="lflex justify-center items-center mt-20 w-full max-w-screen-xl">
        <div className="lg:flex flex-wrap gap-5 justify-center">
          ...
          <div className="flex flex-col lg:w-2/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-center items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Consistency</div>
              <div className="self-stretch mt-2 mr-2 ml-3 text-center text-sm leading-7 opacity-70">
              Aligns course content and learning activities across the program.
              </div>
            </div>
          </div>
