...
const features = [
  {
    ...
    description: "Automate repetitive tasks like grading you more time to focus on learning and teaching."
  },
  {
    title: "Enhanced Engagement:",
    description: "Gamified modules, interactive content, and collaborative tools make learning more exciting, impactful, and enjoyable."
  },
  {
    title: "Security and Compliance:  ",
    description: "Protect sensitive data with advanced encryption, role-based access controls, and compliance-ready systems."
  },
  {
    title: " Anytime, Anywhere Access: ",
    description: "Access all features and resources seamlessly across devices, whether in the classroom or at home."
  }
];
    ...
    <div className="rounded-none">
      <div className="flex mx-20 mt-20 max-md:flex-col">
          <div className="flex flex-col w-6/12 ml-10 -mr-32 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="lms_design_four_images/image 2.png"
