...
<div className="flex overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white bg-opacity-0 w-full px-40 max-md:px-5 max-md:pb-24">
    ...
    Empower Your Educational Journey with Learning Tools
    </h1>
    ...
    The Learning Tools module of Scholar Clone&apos;s LMS solution provides educators and students with a versatile, interactive platform to streamline teaching, learning, and content management. 
    </h4>
...
>
  Get Started Today
    ...
    Innovative Learning Management at Your Fingertips
    </h1>
      ...
      <div className="flex gap-5 max-md:flex-col">
        <div className="flex flex-col w-[57%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col grow mt-20 text-2xl text-slate-800 max-md:mt-10 max-md:max-w-full">
            <div className="flex flex-col items-start self-end px-20 max-w-full w-[733px]">
              ...
              Transform the way you teach and learn with Scholar Clone&apos;s Learning Tools. Designed with educators, students, and institutions in mind, this module integrates cutting-edge features to make education more accessible, engaging, and impactful. Whether you&apos;re tracking progress, delivering lessons, or fostering collaborative learning, Scholar Clone is your ultimate partner.
              </div>
            </div>
          </div>
        </div>
        <div className="flex flex-col lg:-ml-20 lg:pr-34 w-[43%] lg:mt-10 max-md:ml-0 max-md:w-full">
          <div className=" builder-canvas flex relative flex-col pt-8 max-w-[707px] min-h-[390px] max-md:pr-5 max-md:mt-10 max-md:max-w-full">
            <img
              loading="lazy"
              src="/lms_design_four_images/image 1.png"
        ...
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
            <div className="flex overflow-hidden flex-col pt-10 pr-16 pb-16 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              Design lessons that captivate and inspire. Use multimedia resources, 
              customizable templates planning tools to craft engaging 
          ...
          <div className="flex overflow-hidden flex-col pt-10 pr-16 pb-16 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              Empower students with adaptive learning tracks that cater 
          ...
          <div className="flex overflow-hidden flex-col pt-10 pr-16 pb-16 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              <div className="mt-8 text-sm text-zinc-600">
              Keep all your resources in one place. Upload, organize, and retrieve 
              lesson plans, eBooks, videos, and assessments with ease.
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="self-center mt-12 ml-44 max-w-full w-[1000px] max-md:mt-10">
        <div className="flex gap-5 max-md:flex-col">
          ...
          <div className="flex overflow-hidden flex-col pt-10 pr-20 pb-16 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              <div className="mt-8 text-sm text-zinc-600">
              Monitor student performance, identify learning gaps, and provide 
              timely feedback with in-depth analytics and reporting tools.
              </div>
            </div>
          </div>
          ...
          <div className="flex overflow-hidden flex-col pt-10 pr-16 pb-20 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              <div className="mt-8 text-sm text-zinc-600">
              Foster teamwork with integrated tools for discussions  
              and peer-to-peer learning. Make learning a truly collaborative effort.
              </div>
            </div>
          </div>
        </div>
    ...
    Unparalleled Benefits of Scholar Clone&rsquo;s Learning Tools
    </h1>
    <Benefits />
    ...
    Take Charge of Your Learning Experience Today
    </h1>
    <h4 className="text-lg mt-4 px-80 font-inter text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(61, 96, 149, 1)'
    }}>
    Whether you&apos;re an educator looking to enhance your teaching methods or a student eager to unlock your full potential, this is the tool you&apos;ve been waiting for.
    </h4>
