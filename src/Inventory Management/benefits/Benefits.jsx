...
const features = [
  {
    title: "Efficiency: ",
    description: "Eliminate inventory bottlenecks with clear tracking and allocation."
  },
  {
    title: "Cost Savings: ",
    description: "Reduce unnecessary purchases by tracking and optimizing resource usage."
  },
  {
    title: "Transparency: ",
    description: "Improve accountability with real-time tracking and detailed reports."
  },
  {
    title: "Time Savings:",
    description: " Minimize manual effort with automated processes and alerts."
  }
];
    ...
    <div className="rounded-none">
      <div className="flex mx-20 mt-20 max-md:flex-col">
          <div className="flex flex-col w-6/12 ml-10 -mr-32 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="hr_design_four_images/image 10.png"
