...
<div className="flex overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white bg-opacity-0 w-full px-40 max-md:px-5 max-md:pb-24">
    ...
    Effortlessly Manage Your Assets with Scholar Clone HRMS
    </h1>
    ...
    The Inventory Management Module is your one-stop solution for tracking, managing, and optimizing your organization&rsquo;s inventory and resources. Whether it&apos;s office supplies, IT equipment, or department-specific tools, this module ensures every item is accounted for, properly allocated, and maintained with precision.
    </h4>
...
Streamline Your Inventory Management Today!
    ...
    Overview: Simplify Asset Management Across Departments
    </h1>
      ...
      <div className="flex gap-5 max-md:flex-col">
        ...
        <div className="flex flex-col lg:-ml-20 lg:pr-34 w-[43%] lg:mt-10 max-md:ml-0 max-md:w-full">
          <div className=" builder-canvas flex relative flex-col pt-8 max-w-[707px] min-h-[390px] max-md:pr-5 max-md:mt-10 max-md:max-w-full">
            <img
              loading="lazy"
              src="/hr_design_four_images/image 9.png"
    ...
    Why Choose Scholar Clone&apos;s Inventory Management Module?
    </h1>
    <div className="flex overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
        ...
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
            <div className="flex overflow-hidden flex-col pt-10 pr-16 pb-16 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              Automate repetitive tasks such as stock tracking, order management, and reordering,
          ...
          <div className="flex overflow-hidden flex-col pt-10 pr-16 pb-16 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              Monitor asset usage in real-time, ensuring that every item is 
              assigned to the right team member. Asset depreciation and lifecycle analysis.
              </div>
            </div>
          </div>
          <div className="flex flex-col ml-5 w-[33%] max-md:ml-0 max-md:w-full">
          <div className="flex overflow-hidden flex-col pt-10 pr-16 pb-16 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              <div className="mt-8 text-sm text-zinc-600">
              Adapt the inventory system to your organization&rsquo;s unique requirements 
              by defining categories
              selecting preferred tracking methods. 
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="self-center mt-12 ml-44 max-w-full w-[1000px] max-md:mt-10">
        <div className="flex gap-5 max-md:flex-col">
          ...
          <div className="flex overflow-hidden flex-col pt-10 pr-20 pb-16 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              <div className="mt-8 text-sm text-zinc-600">
              Keep inventory data safe with multi-layer encryption and role-based access controls.•	Inventory usage by department or employee.
              </div>
            </div>
          </div>
          ...
          <div className="flex overflow-hidden flex-col pt-10 pr-16 pb-20 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              <div className="mt-8 text-sm text-zinc-600">
              From small teams to large enterprises, this module grows with your organization.Cost and usage trends to help with budgeting.
              </div>
            </div>
          </div>
        </div>
   ...
   Benefits for Your Organization
    ...
    Take Charge of Your Inventory Today
    </h1>
    <h4 className="text-lg mt-4 px-80 font-inter text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(61, 96, 149, 1)'
    }}>
    With the Inventory Management Module, managing your organization&apos;s resources has never been easier. Ensure your teams have the tools they need, when they need them, while keeping costs and waste under control.
    </h4>
