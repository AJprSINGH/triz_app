...
const   features = [
  ...
  },
  {
    ...
    description:
      " Identify rising stars and areas where support is needed.Measure how students interact with the leaderboard.Keep families informed about their child’s progress.",
  },
  {
...
export default function KeyFeatures() {
  return (
    <div className="lg:flex flex-col rounded-[48px] lg:mx-40 mt-[10px]">
      ...
      <div className="lg:flex flex-col items-center lg:px-20 py-10 mt-6 w-full bg-white rounded-[48px] max-md:px-5 max-md:mt-10 max-md:max-w-full"style={{
