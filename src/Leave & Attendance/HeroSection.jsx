  ...
  const featureData = [
    {
      ...
      description: "Ensure accurate timekeeping with biometric, mobile, or web-based tracking."
    },
    {
      title: "Simplify Leave Requests",
      description: "Empower employees to apply for leave and managers to approve instantly."
    },
    {
      title: "Stay Informed, Always",
      description: "Get real-time insights on attendance trends and leave data for better decisions."
    }
  ];
  const features = [
    {
      title: "Automated Attendance Tracking",
      description: "Capture attendance using biometric devices, RFID, or mobile apps for seamless accuracy."
    },
    {
      title: "Custom Leave Policies",
      description: "Configure leave types, accrual rules, and carry-forward options to fit your school’s policies."
    },
    {
      title: "Employee Self-Service Portal",
      description: "Allow staff to view attendance records, check leave balances, and submit requests effortlessly."
    },
    {
      title: "Real-Time Integration with Payroll",
      description: "Sync attendance and leave data for precise salary calculations."
    },
    {
      title: "Detailed Analytics & Reports",
      description: "Gain actionable insights into absenteeism, overtime, and workforce trends to support school operations."
    }
  ];
...
<div className="lg:flex sm:hidden overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    ...
    In today&rsquo;s fast-paced world, managing attendance and leave shouldn&rsquo;t slow you down. With the 
    Leave & Attendance Management Module from Scholar Clone ERP, you get more than just a system you get a 
    solution that works seamlessly, adapts to your needs, and delivers reliable results every time.
    </h4>
...
>
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    ...
    <h4 className="text-xs mr-5 ml-5 mt-6 font-intersemibold text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(18, 20, 29, 1)'
    }}>
    In today&rsquo;s fast-paced world, managing attendance and leave shouldn&rsquo;t slow you down. With the 
    Leave & Attendance Management Module from Scholar Clone ERP, you get more than just a system you get a 
...
>
  Get Started Today
    ...
    <div className="lg:flex sm:hidden overflow-hidden -mt-[10px] relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  >
    <div className="lg:flex sm:hidden flex-col rounded-lg mx-40">
      ...
      Why settle for ordinary when you can choose exceptional?
      </div>
  ...
  >
    ...
    <div className="rounded-none">
      <div className="lg:flex mx-20 lg:mt-20 sm:mt-20 gap-20 max-md:flex-col">
        <div className="flex lg:flex-col lg:w-6/12 max-md:ml-0 max-md:w-full">
          <img
            loading="lazy"
            src="hr_design_two_images/image 1.png"
   ...
   Let&rsquo;s Transform Your Workforce Management
    </h1>
