...
export default function Benefits() {
      ...
      <div className=" w-full pl-20 max-w-full max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-full items-center justify-center  max-md:ml-0 max-md:w-full">
            ...
            Why Choose the Student Academic Profile Module?
            </div>
          </div>
 ...
    </div>
 <div className="sm:flex lg:hidden flex-col pb-5 h-[140vh] bg-white overflow-hidden shadow-[0px_3px_8px_rgba(0,0,0,0.25)] max-md:pl-5">
      <div className=" w-full  max-w-full max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-full items-center justify-center  max-md:ml-0 max-md:w-full">
            <div className=" text-1xl font-inter pl-20 text-center text-sky-800 max-md:mt-10 max-md:max-w-full">
            Why Choose the Student Academic Profile Module?
            </div>
          </div>
