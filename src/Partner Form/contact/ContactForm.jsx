...
const ContactForm = () => {
  ...
  return (
    <form className="flex flex-col items-start px-20 pt-32 pb-80 w-full text-lg font-medium bg-white shadow-[0px_2px_15px_rgba(0,0,0,0.3)] text-zinc-600 max-md:px-5 max-md:py-24 max-md:mt-10 max-md:max-w-full">
