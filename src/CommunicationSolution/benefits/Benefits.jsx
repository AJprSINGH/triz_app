...
export default function Benefits() {
  return (
    <div className="flex overflow-hidden flex-col items-start px-10 pt-8 lg:mt-20 sm:mt-10 pb-8 text-2xl font-bold bg-blue-200 max-md:px-5">
      <div className="flex flex-col max-w-full w-full">
        ...
        <img
          loading="lazy"
          src="Communications Solution Images/Group 1321314685.png"
          alt="XYZ"
          className="w-[100%]"
        />
        </div>
