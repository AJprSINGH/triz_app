...
const features = [
  {
    ...
    title: "Send Late SMS",
    description:
      "Notify parents about delays or schedule changes instantly.",
  },
  {
    ...
    title: "Send SMS to Parents and Staff",
    description:
      "Ensure timely updates with bulk or individual SMS options.",
  },
  {
    ...
    title: "Send Notifications to Parents",
    description:
      "Automate reminders for events, deadlines, and announcements.",
  },
  {
    ...
    description:
      "Share detailed reports, newsletters, and progress updates easily.",
  },
  {
    ...
    title: "Send Emails to Others",
    description:
      " Streamline communication with external stakeholders.",
  },
  {
    ...
    title: "Send WhatsApp Messages to Parents",
    description:
      "Engage with parents using the world’s most popular messaging platform.",
  },
];
