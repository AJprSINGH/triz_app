...
export default function Benefits() {
  return (
        ...
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-full items-center justify-center  max-md:ml-0 max-md:w-full">
            <div className="mt-10 text-3xl font-inter pl-40 text-center text-sky-800 max-md:mt-10 max-md:max-w-full">
              Why Your School Needs the Question Answer Module?
            </div>
          </div>
    ...
    <div className="sm:flex lg:hidden flex-col pb-10 h-[140vh] bg-white overflow-hidden shadow-[0px_3px_8px_rgba(0,0,0,0.25)] max-md:pl-5">
      <div className=" w-full pl-20 max-w-full max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          <div className="lg:flex flex-col w-full items-center justify-center  max-md:ml-0 max-md:w-full">
            <div className="mt-0 text-1 xl font-inter lg:pl-40 text-center text-sky-800 max-md:mt-10 max-md:max-w-full">
              Why Your School Needs the Question Answer Module?
            </div>
          </div>
          <div className="flex flex-col lg:ml-5 mt-0 w-[50%] max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/ba3124853833bab105b0d8711735aebcde4fb580608bd44e5269c444d8d7b955?placeholderIfAbsent=true&apiKey=af5cfb29bb594d4e9f9e505ea3916323"
              className="object-contain grow shrink-0 max-w-full max-md:mt-10"
      ...
      <div className="flex justify-center items-center mt-3 mx-12">
        ...
        <div className="builder-canvas relative max-w-full w-full max-md:mt-10 bg-gray-400 bg-opacity-30 rounded-2xl p-0 border-4 border-gray-400 shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">
          <div className="grid grid-cols-1  gap-0">
            {benefitsData.map((benefit, index) => (
              <div
                key={index}
                className={`p-3 rounded-br-xs  flex flex-col items-start ${
                  index === benefitsData.length - 1
                    ? "bg-[rgb(17,24,38)] text-white bg-"
                    : "text-black"
                }`}
              >
                <div className="text-sm font-inter  mb-3">
                  {benefit.title}
                </div>
