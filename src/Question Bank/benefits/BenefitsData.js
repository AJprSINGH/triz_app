export const benefitsData = [
  ...
  },
  {
    ...
    description:
      "Create interactive and dynamic question formats that capture students' interest and encourage active participation in learning. ",
  },
  {
    title: "Scalability and Flexibility",
    description:
      "Easily expand and adapt the question bank to cater to diverse learning needs and growing user bases. ",
  },
];
