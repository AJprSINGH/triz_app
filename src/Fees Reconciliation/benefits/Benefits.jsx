...
const features = [
  {
    title: "Saves Time:  ",
    description: "Automate manual reconciliation tasks, freeing up administrative hours."
  },
  {
    title: "Ensures Accuracy: ",
    description: "Minimize human errors and discrepancies with automated matching."
  },
  {
    title: "Improves Transparency: ",
    description: "Keep a clear record of all matched and unmatched transactions."
  },
  {
    title: "Simplifies Audits:",
    description: " Generate ready-to-use reports that make audits and financial reviews hassle-free. "
  },
  {
    title: "Enhances Financial Control: ",
    description: "Gain full visibility into fee collections and deposits for better decision-making."
  }
];
    ...
    <div className="rounded-none">
      <div className="flex mx-20 mt-20 max-md:flex-col">
          <div className="flex flex-col w-6/12 ml-10 -mr-32 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="Design_four_images/image.png"
