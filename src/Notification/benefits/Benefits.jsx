...
const features = [
  {
    title: "Transparency: ",
    description: "Keep everyone informed with clear and timely updates."
  },
  {
    title: "Engagement: ",
    description: "Build stronger teacher-parent collaboration for the benefit of the student."
  },
  {
    title: "Convenience: ",
    description: "Access messages and notifications anytime, anywhere, on any device."
  },
  {
    title: "Efficiency: ",
    description: "Save time with automated notifications and easy-to-use chat features."
  }
];
    ...
    <div className="rounded-none">
      <div className="flex mx-20 mt-20 max-md:flex-col">
          <div className="flex flex-col w-6/12 ml-10 -mr-32 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="lms_design_four_images/image 8.png"
