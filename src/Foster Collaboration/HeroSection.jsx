...
<div className="lg:flex sm:hidden overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white text-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    ...
    The Knowledge Sharing & Collaboration Module
    </h1>
    <h4 className="text-lg mt-6 font-intersemibold text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(34, 69, 111, 1)'
    }}>
    Empower your organization to thrive in a knowledge-driven workplace with the Knowledge Sharing & Collaboration Module of Scholar Clone ERP. Enable teams to connect, share, and innovate seamlessly, transforming knowledge into a powerful driver of success.
    </h4>
    ...
    <div className="overflow-hidden">
      <div className="lg:flex sm:hidden gap-5 max-md:flex-col">
        <div className="flex flex-col w-[57%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col grow mt-14 text-2xl text-slate-800 max-md:mt-10 max-md:max-w-full">
            <div className="flex flex-col items-start self-end mt-24 px-20 max-w-full w-[733px]">
              ...
              Revolutionize the Way Your Team Collaborates
              </div>
              <div className="mt-5 text-lg font-interregular leading-6 w-[571px] max-md:max-w-full">
              Whether it&rsquo;s fostering teamwork across departments, enabling peer-to-peer learning, or 
              creating a centralized hub for resources, the Knowledge Sharing & Collaboration Module 
              simplifies and amplifies the way your organization communicates and collaborates.
              </div>
              <div className="mt-8 text-lg leading-6 w-[601px] max-md:max-w-full">
              With this module, your workforce can break down silos, enhance knowledge 
              accessibility, and build a culture of shared success.
              </div>
              <div className="flex flex-wrap gap-5 self-stretch mt-11 text-sm font-inter max-md:mt-10">
              <div className="font-medium w-[169px]">
                  <span className="font-bold">Streamline Information:</span> <br />
                  Ensure every team member has the tools and resources they need at their fingertips.
                </div>
                <div className="font-medium w-[169px]">
                  <span className="font-bold">Boost Team Productivitys:</span> <br />
                  Enable real-time collaboration to meet project goals faster.
                </div>
                <div className="w-[169px]">
                Learning Culturen:{" "}
                  <span className="">
                  Encourage continuous learning and the exchange of ideas across teams.
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col lg:-ml-20 lg:pr-34 w-[43%] max-md:ml-0 max-md:w-full">
          <div className=" builder-canvas flex relative flex-col pt-12 max-w-[707px] min-h-[590px] max-md:pr-5 max-md:mt-10 max-md:max-w-full">
            ...
            <img
              loading="lazy"
              src="/hr_design_five_images/image 5.png"
      ...
      <div className="sm:flex lg:hidden gap-5 max-md:flex-col">
        <div className="flex flex-col lg:w-[57%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col grow mt-7 text-1xl text-slate-900 max-md:mt-10 max-md:max-w-full">
            <div className="flex flex-col items-start self-end mt-12 px-8 max-w-full lg:w-[733px]">
      ...
      <div className="w-full max-w-[1541px] max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-2/5 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="/hr_design_five_images/image 6.png"
          ...
          <div className="flex flex-col ml-5 w-3/5 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col self-stretch my-auto w-full max-md:mt-10 max-md:max-w-full">
              ...
              Top Features of the Knowledge Sharing & Collaboration Module
              </div>
      ...
      <div className="w-full max-w-[1541px] max-md:max-w-full">
        <div className="lg:flex gap-5 max-md:flex-col">
          ...
          <div className="flex flex-col ml-5 lg:w-3/5 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col self-stretch my-auto w-full max-md:mt-10 max-md:max-w-full">
              <div className="text-2xl text-center font-inter tracking-tighter text-sky-800 max-md:max-w-full">
              Top Features of the Knowledge Sharing & Collaboration Module
              </div>
              ...
              <div className="mt-5 mr-3 text-center max-md:mr-2.5 max-md:max-w-full">
                <div className="lg:flex  gap-5 max-md:flex-col">
                  <div className="flex flex-col lg:w-6/12 max-md:ml-0 max-md:w-full">
                    <div className="flex flex-col items-center items-start text-xs font-inter text-slate-800 max-md:mt-10">
                      <div className="self-stretch">
                      Centralized Knowledge Repository
                      </div>
                  ...
                  <div className="flex flex-col   lg:w-6/12 max-md:ml-0 max-md:w-full">
                    <div className="flex flex-col grow items-center items-start text-xs font-inter text-slate-800 max-md:mt-10">
