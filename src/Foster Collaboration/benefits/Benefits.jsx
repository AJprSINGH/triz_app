      ...
      <div className=" w-full pl-20 max-w-full max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-full items-center justify-center  max-md:ml-0 max-md:w-full">
            ...
            Why Your Organization Needs the Knowledge Sharing & Collaboration Module?
            </div>
          </div>
...
<div className="sm:flex lg:hidden flex-col pb-5 h-[190vh] bg-white overflow-hidden shadow-[0px_3px_8px_rgba(0,0,0,0.25)] max-md:pl-5">
      <div className=" w-full pl-10 max-w-full max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-full items-center justify-center  max-md:ml-0 max-md:w-full">
            <div className="text-1xl font-inter  text-center text-sky-800 max-md:mt-10 max-md:max-w-full">
            Why Your Organization Needs the Knowledge Sharing & Collaboration Module?
            </div>
          </div>
          <div className="flex flex-col ml-3 w-[50%] max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/ba3124853833bab105b0d8711735aebcde4fb580608bd44e5269c444d8d7b955?placeholderIfAbsent=true&apiKey=af5cfb29bb594d4e9f9e505ea3916323"
              className="object-contain grow shrink-0 max-w-full max-md:mt-10"
