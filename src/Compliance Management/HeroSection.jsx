...
<div className="flex overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white bg-opacity-0 w-full px-40 max-md:px-5 max-md:pb-24">
    ...
    Simplify Policy Tracking and Implementation
    </h1>
...
Managing school policies and ensuring their effective implementation is essential for maintaining order, 
achieving goals, and adhering to regulations. The  Module from Scholar Clone ERP System is
 specifically designed to help schools streamline policy tracking and implementation with ease and precision.
<p>Whether it&rsquo;s academic policies, operational guidelines, or safety protocols, this module keeps your school aligned and 
organized, making policy management hassle-free.</p>
    </h4>
...
>
  Get Started Today
    ...
    Why Focus on Policy Tracking and Implementation?
    </h1>
        ...
        <div className="flex flex-col w-[57%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col grow mt-20 text-2xl text-slate-800 max-md:mt-10 max-md:max-w-full">
            <div className="flex flex-col items-start self-end px-20 max-w-full w-[733px]">
              ...
              Policies are the backbone of your school&rsquo;s operations. Without a proper system in place, tracking their implementation 
              can be challenging and lead to:Confusion among staff and students.Ineffective adherence to guidelines.Unintentional 
              non-compliance with education standards or regulations.The Compliance Management Module ensures that your school&rsquo;s policies are not just well-documented but actively followed and monitored.
              </div>
            </div>
          </div>
        </div>
    ...
    Key Features of the Policy Tracking and Implementation System
    </h1>
    <div className="flex overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
      ...
      <div className="w-[1200px] max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          ...
          <div className="flex overflow-hidden flex-col pt-10 pr-16 pb-16 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              <div className="mt-8 text-sm text-zinc-600">
              Notify relevant staff about pending policy tasks, deadlines, or updates.
              Tailor notifications for specific policies or teams to ensure timely action.
              Set periodic reminders for policy reviews or audits.
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="self-center mt-12 ml-44 max-w-full w-[1000px] max-md:mt-10">
        <div className="flex gap-5 max-md:flex-col">
          ...
          <div className="flex overflow-hidden flex-col pt-10 pr-20 pb-16 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              <div className="mt-8 text-sm text-zinc-600">
              Generate detailed reports showing which policies are fully implemented, in progress, or pending.
              Identify areas where policies need better adherence or enforcement.
              </div>
            </div>
          </div>
          ...
          <div className="flex overflow-hidden flex-col pt-10 pr-16 pb-20 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              <div className="mt-8 text-sm text-zinc-600">
              Ensure only authorized personnel can view or edit specific policies.
              Enable teams to work together on policy implementation securely and efficiently.
              </div>
            </div>
          </div>
        </div>
    ...
    Take Control of Your School&rsquo;s Policies Today
    </h1>
    <h4 className="text-lg mt-4 px-80 font-inter text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(61, 96, 149, 1)'
    }}>
Eliminate the chaos of manual policy tracking and let the Compliance Management Module help you<br/>
•	Centralize your policies.<br/>
