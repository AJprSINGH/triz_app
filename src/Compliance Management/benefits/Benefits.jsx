...
const features = [
  {
    ...
    description: "Ensure everyone in your school understands and follows the same set of guidelines."
  },
  {
    title: "Accountability:",
    description: " Assign clear responsibilities to individuals or departments for seamless implementation."
  },
  {
    title: "Time-Saving Automation:  ",
    description: "Automate policy tracking, reminders, and reporting to free up administrative time."
  },
  {
    title: "Improved Efficiency:  ",
    description: "Streamline policy updates and ensure smooth transitions with minimal disruptions."
  },
  {
     title: "Transparent Operations: ",
     description: "Provide administrators and stakeholders with a clear view of policy progress and adherence."
  }
];
    ...
    <div className="rounded-none">
      <div className="flex mx-20 mt-20 max-md:flex-col">
          <div className="flex flex-col w-6/12 ml-10 -mr-32 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="Design_four_images/image 2.jpg"
