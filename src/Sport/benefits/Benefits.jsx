...
const features = [
  {
    ...
    description: "Build your personal collection of resources that align with your goals."
  },
  {
    title: "Integration: ",
    description: "Leverage tools for training, learning, and game analysis seamlessly."
  },
  {
    title: "Engagement: ",
    description: "Interactive features like quizzes, games, and progress tracking keep you motivated."
  }
];
    ...
    <div className="rounded-none">
      <div className="flex mx-20 mt-20 max-md:flex-col">
          <div className="flex flex-col w-6/12 ml-10 -mr-32 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="lms_design_four_images/image 5.png"
