...
const features = [
  {
    ...
    description: "Ensure departments operate smoothly with clear task and role assignments."
  },
  {
    title: "Transparency Across Teams:",
    description: " Keep all employees aligned with shared resources and guidelines."
  },
  {
    title: "Skill Optimization:",
    description: " Leverage employee skills effectively by mapping them to the right tasks and roles."
  },
  {
    title: "Time Savings: ",
    description: "Automate manual tracking and communication processes, saving valuable time for managers."
  }
];
    ...
    <div className="rounded-none">
      <div className="flex mx-20 mt-20 max-md:flex-col">
          <div className="flex flex-col w-6/12 ml-10 -mr-32 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="hr_design_four_images/image 8.png"
