...
<div className="flex overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white bg-opacity-0 w-full px-40 max-md:px-5 max-md:pb-24">
    ...
    Unlock the Power of Insights with Our Prediction Analysis for Admissions Module
    </h1>
    ...
    Make smarter, data-driven decisions with our Prediction Analysis for Admissions Module—a sophisticated tool designed to analyze previous year&rsquo;s admission data and predict trends for upcoming admission cycles. 
    </h4>
...
>
  Get Started Today
    ...
    What is the Prediction Analysis for Admissions Module?
    </h1>
      ...
      <div className="flex gap-5 max-md:flex-col">
        <div className="flex flex-col w-[57%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col grow mt-20 text-2xl text-slate-800 max-md:mt-10 max-md:max-w-full">
            <div className="flex flex-col items-start self-end px-20 max-w-full w-[733px]">
              ...
              The Prediction Analysis for Admissions Module uses advanced analytics and machine learning to process historical data, uncover patterns, and forecast future admission trends. By analyzing metrics like application volume, acceptance rates, demographics, and program popularity, this module empowers institutions to streamline their admissions processes and improve forecasting accuracy.
              </div>
            </div>
          </div>
        </div>
        <div className="flex flex-col lg:-ml-20 lg:pr-34 w-[43%] lg:mt-10 max-md:ml-0 max-md:w-full">
          <div className=" builder-canvas flex relative flex-col pt-8 max-w-[707px] min-h-[390px] max-md:pr-5 max-md:mt-10 max-md:max-w-full">
            <img
              loading="lazy"
              src="/Analytics_design_one_images/image 7.webp"
    ...
    Why Choose Our Prediction Analysis Module?
    </h1>
    <div className="flex overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
      ...
      <div className="w-[1200px] max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          ...
          <div className="flex overflow-hidden flex-col pt-10 pr-16 pb-16 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              Simplify data with clear, actionable visuals for better decision-making.
              </div>
            </div>
          </div>
          <div className="flex flex-col ml-5 w-[33%] max-md:ml-0 max-md:w-full">
          <div className="flex overflow-hidden flex-col pt-10 pr-16 pb-16 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              <div className="mt-8 text-sm text-zinc-600">
              Customize tools to fit your institution&rsquo;s unique goals and challenges.
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="self-center mt-12 ml-44 max-w-full w-[1000px] max-md:mt-10">
        <div className="flex gap-5 max-md:flex-col">
          ...
          <div className="flex overflow-hidden flex-col pt-10 pr-20 pb-16 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              <div className="mt-8 text-sm text-zinc-600">
              Automate processes to save time and minimize manual effort.
              </div>
            </div>
          </div>
    ...
    Benefits of Using the Prediction Analysis Module
    </h1>
    <Benefits />
    ...
    Transform Your Admissions Strategy Today!
    </h1>
    <h4 className="text-lg mt-4 px-80 font-inter text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(61, 96, 149, 1)'
    }}>
    Harness the power of analytics to gain unparalleled insights into your institution&rsquo;s admission trends.
    </h4>
  ...
  aria-label="Book Your Demo Now"
>
  Get Started Predicting Your Success!
</button>
</div>
</div>
<Footer />
