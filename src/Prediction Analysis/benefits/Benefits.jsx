...
const features = [
  {
    ...
    description: "Prepare for admission cycles with data-backed insights."
  },
  {
    title: "Improved Accuracy",
    description: "Leverage historical data and AI to reduce guesswork."
  },
  {
    title: "Better Resource Allocation ",
    description: "Plan staff, marketing budgets, and infrastructure needs efficiently."
  },
  {
    title: "Increased Enrollment Rates ",
    description: "Focus recruitment efforts where they matter most."
  }
];
    ...
    <div className="rounded-none">
      <div className="flex mx-20 mt-20 max-md:flex-col">
          <div className="flex flex-col w-6/12 ml-10 -mr-32 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="Analytics_design_one_images/image 8.png"
