  ...
  const featureData = [
    {
      ...
      description: "Multiple payment options, including UPI, credit/debit cards, net banking, and wallets."
    },
    {
      title: "Notifications",
      description: "Automated notifications for due dates, receipts, and payment confirmations."
    },
    {
      title: "User-friendly ",
      description: "A user-friendly portal for parents to view and pay fees anytime, anywhere."
    }
  ];
  const features = [
    {
      title: "Flexible Payment Options ",
      description: "Offer parents multiple secure payment methods for convenience."
    },
    {
      title: "Customizable Fee Structures ",
      description: "Define fees by class, term, or category effortlessly."
    },
    {
      title: "Automated Receipts",
      description: "Generate instant receipts after successful transactions."
    },
    {
      title: "Real-Time Tracking",
      description: "Monitor payments and defaulters with a centralized dashboard."
    },
    {
      title: "Reminders & Alerts",
      description: "Notify parents about upcoming due dates and overdue payments automatically."
    },
    {
      title: "Comprehensive Reports",
      description: "Access detailed financial analytics for informed decision-making."
    },
    {
      title: "Integration with Accounting Systems:",
      description: " Sync with your school’s finance module for seamless reconciliation."
    }
  ];
...
<div className="lg:flex sm:hidden overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    ...
    Simplify Fee Collection for Schools
    </h1>
...
<div className="sm:flex lg:hidden overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  >
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    <h1 className="text-2xl font-lxe mr-2 ml-2 text-center max-md:max-w-full max-md:text-4xl underline decoration-[rgba(34,226,127,1)] decoration-4">
    Simplify Fee Collection for Schools
    </h1>
...
Get Started Today
  ...
  >
    <div className="flex flex-col rounded-lg mx-40">
      ...
      Effortless Fee Collection for Modern Schools
      </div>
  ...
  >
    ...
    <div className="rounded-none">
      <div className="lg:flex mx-20 mt-20 gap-20 max-md:flex-col">
        ...
        <div className="flex flex-col lg:w-6/12 mt-10 max-md:ml-0 max-md:w-full">
          ...
          <h1 className="z-10 self-start mt-0 lg:text-4xl sm:text-1xl font-lxesemibold tracking-tighter text-zinc-900 max-md:max-w-full underline decoration-[rgba(34,226,127,1)] decoration-4">
          Smart Features for Efficient Fee Management
      </h1>
    ...
    <Benefits />
    <h1 className="lg:text-3xl sm:text-1xl lg:mt-40 sm:mt-10 font-lxesemibold text-center max-md:max-w-full max-md:text-4xl underline decoration-[rgba(34,226,127,1)] decoration-4"style={{
        color:'rgb(10, 10, 10)'
    }}>
    Upgrade to a Smarter Fee Management System
    </h1>
