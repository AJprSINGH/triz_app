...
<div className="lg:flex sm:hidden overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white text-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    ...
    Effortless Compliance, Seamless Operations
    </h1>
    <h4 className="text-lg mt-6 font-intersemibold text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(34, 69, 111, 1)'
    }}>
   In today&rsquo;s dynamic business landscape, ensuring compliance with legal and organizational regulations is critical for maintaining credibility and avoiding penalties. Scholar Clone ERP&rsquo;s Compliance Management Module empowers businesses with a streamlined, user-friendly solution to manage, monitor, and stay on top of all compliance requirements effortlessly.
    </h4>
...
>
  Get Started Today
      ...
      <div className="lg:flex sm:hidden gap-5 max-md:flex-col">
        <div className="flex flex-col w-[57%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col grow mt-14 text-2xl text-slate-800 max-md:mt-10 max-md:max-w-full">
            <div className="flex flex-col items-start self-end mt-24 px-20 max-w-full w-[733px]">
              ...
              Overview of the Compliance Management Module
              </div>
              <div className="mt-5 text-lg font-interregular leading-6 w-[571px] max-md:max-w-full">
              The Compliance Management Module in Scholar Clone ERP is a sophisticated, all-in-one solution 
              designed to help organizations maintain alignment with local, national, and international regulatory 
              frameworks.
              </div>
              <div className="mt-8 text-lg leading-6 w-[601px] max-md:max-w-full">
              From automating compliance tracking to generating detailed reports, the module simplifies and enhances 
              the way businesses meet their legal obligations.
              </div>
              ...
              <div className="font-medium w-[169px]">
                  ...
                  Minimize compliance risks with automated tracking and real-time monitoring.
                </div>
                <div className="font-medium w-[169px]">
                  <span className="font-bold">Organize Complaints:</span> <br />
                  Ensure clear visibility into compliance status across your organization.
                </div>
                <div className="w-[169px]">
                  Enhance Communication:{" "}
                  <span className="">
                  Easily integrate with existing HR systems for a unified compliance platform.
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col lg:-ml-20 lg:pr-34 w-[43%] max-md:ml-0 max-md:w-full">
          <div className=" builder-canvas flex relative flex-col pt-12 max-w-[707px] min-h-[590px] max-md:pr-5 max-md:mt-10 max-md:max-w-full">
            ...
            <img
              loading="lazy"
              src="/hr_design_five_images/image 1.png"
        ...
        <div className="flex flex-col lg:w-[57%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col grow mt-7 text-1xl text-slate-800 max-md:mt-10 max-md:max-w-full">
            <div className="flex flex-col items-start self-end mt-12 px-10 max-w-full lg:w-[733px]">
              <div className="mt-0 text-1xl font-inter text-sky-800 max-md:max-w-full">
              Overview of the Compliance Management Module
              </div>
              ...
              <div className="mt-3 text-sm leading-6 lg:w-[601px] max-md:max-w-full">
              From automating compliance tracking to generating detailed reports, the module simplifies and enhances 
              the way businesses meet their legal obligations.
              </div>
      ...
      <div className="w-full max-w-[1541px] max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-2/5 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="/hr_design_five_images/image 2.png"
                ...
                <div className="flex gap-5 max-md:flex-col">
                  <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                    <div className="flex flex-col items-start text-xl font-inter text-slate-800 max-md:mt-10">
                      ...
                      Regulation Updates Integration
                      </div>
                      <div className="mt-12 max-md:mt-10">
      ...
      <div className="w-full max-w-[1541px] max-md:max-w-full">
        <div className="lg:flex gap-5 max-md:flex-col">
          ...
          <div className="flex flex-col ml-3 lg:w-3/5 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col self-stretch my-auto w-full max-md:mt-10 max-md:max-w-full">
              <div className="text-1xl mt-3 text-center font-inter tracking-tighter text-sky-800 max-md:max-w-full">
              Key Features That Set Us Apart
              </div>
    ...
    Book a Free Demo and experience how Scholar Clone ERP&rsquo;s <br/>Compliance Management Module can revolutionize
    <br/> the way you manage compliance.
    </h4>
