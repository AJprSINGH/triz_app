...
const features = [
  {
    title: "Transparency: ",
    description: "Clear and structured pathways for success."
  },
  {
    title: "Time Savings:",
    description: "Boost confidence with tailored guidance and support."
  },
  {
    title: "Security: ",
    description: "Save time with pre-built, customizable templates."
  },
  {
    title: "Compliance: ",
    description: "Track student progress and provide targeted interventions."
  }
];
    ...
    <div className="rounded-none">
      <div className="flex mx-20 mt-20 max-md:flex-col">
          <div className="flex flex-col w-6/12 ml-10 -mr-32 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="lms_design_four_images/image 10.png"
