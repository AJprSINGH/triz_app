...
const features = [
  {
    ...
    title: "Tailored Compliance Curriculum",
    description:
      "Stay ahead of industry standards with courses customized for your regulatory landscape, covering topics ",
  },
  {
    ...
    title: "Interactive & Engaging Formats",
    description:
      "Our training includes videos, quizzes, and case studies to ensure that employees retain critical information.",
  },
  {
    ...
    description:
      "Employees can access training materials anytime, anywhere, from their desktop or mobile device.",
  },
  {
    ...
    description:
      "Track team progress in real-time, and celebrate milestones with completion certificates.",
  },
  {
    ...
    description:
      "Break language barriers with training materials available in multiple languages.",
  },
  {
    ...
    description:
      "Stay informed with the latest regulatory changes and industry trends through regularly updated content created by compliance experts. ",
  },
];
...
export default function KeyFeatures() {
  return (
    <div className="flex flex-col rounded-[48px] lg:mx-40 sm:mx-10 mt-[10px]">
      ...
      <div className="flex flex-col items-center lg:px-20 py-10 mt-6 w-full bg-white rounded-[48px] max-md:px-5 max-md:mt-10 max-md:max-w-full"style={{
