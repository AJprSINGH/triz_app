...
const HERO_BUTTONS = [
  ...
  const featureData = [
    {
      title: "Define Roles with Ease",
      description: "Assign role-based access to ensure teams access only what they need."
    },
    {
      title: "Protect Sensitive Data",
      description: "Secure HR and payroll information with advanced security and custom controls."
    },
    {
      title: "Streamline Team Management",
      description: "Enable efficient collaboration with tailored tools and secure access."
    }
  ];
  const features = [
    {
      title: "Role-Based Access Control ",
      description: "Assign specific roles with predefined access levels to streamline user management."
    },
    {
      title: "Granular Permission Settings",
      description: "Set up detailed permissions for individual modules like payroll, attendance, or leave management to align with your organizational hierarchy."
    },
    {
      title: "Customizable User Groups",
      description: "Group users with similar responsibilities and assign them tailored access controls for faster setup and adjustments."
    },
    {
      title: "Audit Trails & Monitoring",
      description: "Track who accessed what and when with detailed logs to ensure transparency and accountability."
    },
    {
      title: "Seamless Module Integration",
      description: "Integrate access control with other Scholar Clone ERP modules, such as payroll, attendance, and leave management, for a unified experience."
    }
  ];
...
<div className="flex overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    ...
    Simplify Your User-Level Control & Rights Management
    </h1>
    <h4 className="text-lg mt-20 font-intersemibold text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(18, 20, 29, 1)'
    }}>
    Take full control of your HR processes with the User-Level Control & Rights Management Module of Scholar Clone ERP. Assign roles, define permissions, and manage access with precision ensuring your sensitive data remains secure while empowering your team with the right tools.
    </h4>
...
>
  ...
  >
    <div className="flex flex-col rounded-lg mx-40">
      ...
      Smart Tools to Manage Access & Permissions
      </div>
    ...
    <div className="rounded-none">
      <div className="flex mx-20 mt-20 gap-20 max-md:flex-col">
        <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
          <img
            loading="lazy"
            src="hr_design_two_images/image 2.png"
   ...
   Let&rsquo;s Transform Your Access Management
    </h1>
