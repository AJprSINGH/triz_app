...
export default function Benefits() {
  return (<>
        ...
        <div className="flex flex-wrap gap-5 justify-center">
          ...
          <div className="flex flex-col w-2/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              Automate petty cash logging and approvals, freeing up administrative staff for other priorities.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Increased Transparency</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Maintain clear records of every transaction and approval for better accountability.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Eliminate Errors</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Minimize discrepancies in petty cash handling with automated tracking and accurate reporting.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Simplify Audits</div>
              <div className="mt-4 text-sm  opacity-70 leading-7 w-[350px]">
              With detailed records and reports, auditing petty cash becomes quick and hassle-free.
              </div>
              {/* <img
                loading="lazy"
    ...
    >
      ...
      {/* Benefits Section */}
      <div className="lg:flex justify-center items-center mt-20 w-full max-w-screen-xl">
        <div className="lg:flex flex-wrap gap-5 justify-center">
          ...
          <div className="flex flex-col lg:w-2/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-center items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Save Time</div>
              <div className="self-stretch mt-2 text-xs mr-2 ml-2 text-center leading-7 opacity-70">
              Automate petty cash logging and approvals, freeing up administrative staff for other priorities.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-center items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Increased Transparency</div>
              <div className="self-stretch mt-2 text-xs text-center mr-2 ml-2  leading-7 opacity-70">
              Maintain clear records of every transaction and approval for better accountability.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-center items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Simplify Audits</div>
              <div className="mt-4 text-xs text-center mr-2 ml-2   opacity-70 leading-7 w-[350px]">
              With detailed records and reports, auditing petty cash becomes quick and hassle-free.
              </div>
              {/* <img
                loading="lazy"
