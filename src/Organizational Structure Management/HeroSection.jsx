...
const HERO_BUTTONS = [
  ...
  const features = [
    {
      title: "Comprehensive Organization Details",
      description: "Easily add and update branches, units, logos, and addresses."
    },
    {
      title: "Skill Library Management",
      description: "Build and maintain a complete skill taxonomy, or import your existing data for seamless integration."
    },
    {
      title: "Hierarchy Customizations",
      description: "Map out your organization’s structure with roles, reporting lines, and departmental setups."
    },
    // {
  ...
  const ctaButtons = [
    {
      text: "Take Control of Your Organization Today! ",
        ...
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-[55%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-start mt-6 w-full text-2xl font-medium max-md:mt-10 max-md:max-w-full">
              ...
              Build a Strong Foundation with Organizational Structure Management
              </div>
              <div className="self-stretch text-lg mt-12 text-black max-md:mt-10 max-md:max-w-full">
              Seamlessly organize, manage, and scale your business with Scholar Clone&rsquo;s Organizational Structure Management Module. This powerful tool allows you to visualize, define, and optimize your organization&rsquo;s framework laying the groundwork for efficient operations and strategic growth.
              </div>
          ...
          <div className="flex flex-col ml-5 w-[45%] max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="/hr_design_three_images/image 10.png"
...
<div className="sm:flex lg:hidden overflow-hidden flex-col justify-center items-start font-inter px-16 py-10 w-full max-md:px-5 max-md:py-24 max-md:max-w-full" style={{
        ...
        <div className="lg:flex gap-5 max-md:flex-col">
          <div className="flex flex-col lg:w-[55%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-start mt-3 w-full text-1xl font-medium max-md:mt-10 max-md:max-w-full">
              ...
              <div className="flex lg:flex-wrap gap-10 text-[11px] mt-6 mb-2  max-w-full text-white w-[547px] max-md:mt-10">
                {ctaButtons.map((button, index) => (
                  <button 
                  key={index}
                  className={button.className}
    ...
    <div className="rounded-none">
      <div className="lg:flex sm:hidden mx-20 mt-24 max-md:flex-col">
        <div className="flex flex-col w-6/12 pr-36 max-md:ml-0 max-md:w-full">
          <img
            loading="lazy"
            src="hr_design_three_images/image 11.webp"
        ...
        <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
          ...
          Centralize and Simplify Organizational Management
      </h1>
      <div className="z-10 mt-4 max-md:mt-10 max-md:max-w-full">
        <p className="text-lg font-interregular">With Scholar Clone&rsquo;s Organizational Structure Management Module, you can effortlessly handle:</p>
      ...
      <div className="sm:flex lg:hidden mx-10 mt-12 max-md:flex-col">
        {/* <div className="flex flex-col w-12/12 pr-36 max-md:ml-0 max-md:w-full">
          <img
            loading="lazy"
            src="hr_design_three_images/image 11.webp"
            alt="Educational CRM platform interface showcase"
      ...
      <div className="z-10 mt-2 max-md:mt-10 max-md:max-w-full">
        <p className="text-sm font-interregular">With Scholar Clone&rsquo;s Organizational Structure Management Module, you can effortlessly handle:</p>
        {features.map((feature, index) => (
          <div key={index} className="mb-1">
          <ul className="list-disc pl-5">
    ...
    <h1 className="lg:text-4xl sm:text-2xl text-center font-intersemibold lg:mt-40 sm:mt-10"style={{
            ...
            Robust Features That Empower Your Organization
    </h1>
    <Features />
    <Benefits />
        ...
        <div className="flex flex-col w-[78%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col w-full items-center justify-center pr-36 text-blue-800 max-md:max-w-full">
            ...
            <div className="mt-8 text-2xl font-interregular max-md:mr-2.5 max-md:max-w-full">
             With Scholar Clone&rsquo;s Organizational Structure Management Module, 
            you can build a strong foundation for seamless growth and operational efficiency.
            </div>
