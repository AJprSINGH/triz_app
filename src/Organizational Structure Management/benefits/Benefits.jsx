        ...
        <div className="flex flex-wrap gap-5 justify-center">
          ...
          <div className="flex flex-col w-2/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              Automate manual processes and minimize administrative overhead.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Boost Efficiency: </div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Centralized data ensures smooth communication and reduced duplication of effort.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Drive Growth</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              A well-defined structure allows your organization to expand without chaos.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Stay Organized</div>
              <div className="mt-4 text-sm  opacity-70 leading-7 w-[350px]">
              Ensure every branch, unit, and skill aligns with your business strategy.
              </div>
              {/* <img
                loading="lazy"
