...
<div className="lg:flex sm:hidden overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white text-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    ...
    Create an engaging and interactive learning experience with the Social & Collaborative Learning Module by Scholar Clone. This module is designed to bring students, teachers, and parents together on a shared platform to collaborate, exchange ideas, and enhance learning outcomes.
    </h4>
...
>
  Get Started Today
        ...
        <div className="flex flex-col w-[57%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col grow mt-14 text-2xl text-slate-800 max-md:mt-10 max-md:max-w-full">
            <div className="flex flex-col items-start self-end mt-24 px-20 max-w-full w-[733px]">
              ...
              A Better Way to Support Teamwork & Shared Learning
              </div>
              <div className="mt-5 text-lg font-interregular leading-6 w-[571px] max-md:max-w-full">
              Whether it&rsquo;s working on assignments, sharing resources, or discussing ideas,
               this module helps every member of your school community stay connected and productive.
              </div>
              <div className="mt-8 text-lg leading-6 w-[601px] max-md:max-w-full">
              The Social & Collaborative Learning Module simplifies how schools enable group 
              projects, discussions, and communication. 
              </div>
              <div className="flex flex-wrap gap-5 self-stretch mt-11 text-sm font-inter max-md:mt-10">
              <div className="font-medium w-[169px]">
                  <span className="font-bold">Encourage Teamwork:</span> <br />
                  Let students and staff easily work together on assignments and projects.
                </div>
                <div className="font-medium w-[169px]">
                  <span className="font-bold">Improve Communication:</span> <br />
                  Keep everyone informed with messaging tools and updates.
                </div>
                <div className="w-[169px]">
                Support Knowledge Sharing:{" "}
                  <span className="">
                  Provide a space for sharing resources, ideas, and feedback.
                  </span>
                </div>
              </div>
            </div>
      ...
      <div className="sm:flex lg:hidden gap-5 max-md:flex-col">
        <div className="flex flex-col lg:w-[57%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col grow mt-7 text-2xl text-slate-800 max-md:mt-10 max-md:max-w-full">
            <div className="flex flex-col items-start self-end mt-12 px-5 max-w-full lg:w-[733px]">
              ...
              <div className="mt-4 text-sm leading-6 lg:w-[601px] max-md:max-w-full">
              The Social & Collaborative Learning Module simplifies how schools enable group 
              projects, discussions, and communication. 
              </div>
        ...
        {/* <div className="flex flex-col lg:-ml-20 lg:pr-34 w-[30%] max-md:ml-0 max-md:w-full">
          <div className=" builder-canvas flex relative flex-col pt-12 max-w-[707px] min-h-[590px] max-md:pr-5 max-md:mt-10 max-md:max-w-full">
            <div className="flex absolute -left-px shrink-0 rounded-full border-green-600 border-solid border-[25px] h-[246px] top-[344px] w-[246px]" />
            <img
              loading="lazy"
      ...
      <div className="w-full max-w-[1541px] max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-2/5 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="/cc_design_four_images/image 6.png"
          ...
          <div className="flex flex-col ml-5 w-3/5 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col self-stretch my-auto w-full max-md:mt-10 max-md:max-w-full">
              ...
              Key Features of the Social & Collaborative 
              </div>
              <div className="self-start mt-10 text-lg font-interregular leading-6 text-slate-800 max-md:max-w-full">
              The module is packed with user-friendly features that promote active learning and teamwork:
              </div>
      ...
      <div className="w-full max-w-[1541px] max-md:max-w-full">
        <div className="lg:flex gap-5 max-md:flex-col">
          ...
          <div className="flex flex-col ml-3 lg:w-3/5 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col self-stretch my-auto w-full max-md:mt-10 max-md:max-w-full">
              <div className=" mt-5 text-1xl font-inter tracking-tighter text-sky-800 max-md:max-w-full">
              Key Features of the Social & Collaborative 
              </div>
    ...
    Ready to Build a More Collaborative Learning Environment?
    </h1>
    <h4 className="lg:text-4xl sm:mr-1 sm:ml-1 sm:text-2xl mt-4 font-quicksandbold text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(21, 70, 120, 1)'
    }}>
    Start making collaboration easier and learning more engaging <br/>for your school community.
    </h4>
