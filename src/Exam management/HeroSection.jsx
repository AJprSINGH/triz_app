...
<div className="flex overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white bg-opacity-0 w-full px-40 max-md:px-5 max-md:pb-24">
    ...
    Effortlessly organize, track, and manage every step of your school&rsquo;s exams and results. 
    </h1>
...
Managing exams and generating accurate, professional report cards can be time-consuming and prone to errors without 
the right tools. The Exam Management & Result/Report Card Module from Scholar Clone ERP is your all-in-one solution for 
organizing exams, recording results, and delivering comprehensive report cards with ease and accuracy.
This module helps schools streamline the entire process, from scheduling exams to publishing results, 
while ensuring that parents, teachers, and students stay informed at every step.
    </h4>
...
>
  Get Started Today
    ...
    Why Choose the Exam Management & Result/Report Card Module?
    </h1>
...
•	Time-Consuming Report Cards: Generating detailed, professional report cards for each student.<br/>
The Exam Management & Result/Report Card Module resolves these challenges, allowing schools to focus on academic excellence.
              </div>
            </div>
          </div>
        </div>
        <div className="flex flex-col lg:-ml-20 lg:pr-34 w-[43%] lg:mt-10 max-md:ml-0 max-md:w-full">
          <div className=" builder-canvas flex relative flex-col pt-8 max-w-[707px] min-h-[390px] max-md:pr-5 max-md:mt-10 max-md:max-w-full">
            <img
              loading="lazy"
              src="/Design_four_images/image 7.webp"
   ...
   Key Features of the Exam Management & Result/Report Card Module
    </h1>
    <div className="flex overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
        ...
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
            <div className="flex overflow-hidden flex-col pt-10 pr-16 pb-16 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              Plan and schedule exams for multiple grades and sections with ease.
              Avoid overlapping exams with automated conflict detection.
      ...
      <div className="self-center mt-12 ml-44 max-w-full w-[1000px] max-md:mt-10">
        <div className="flex gap-5 max-md:flex-col">
          ...
          <div className="flex overflow-hidden flex-col pt-10 pr-20 pb-16 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              <div className="mt-8 text-sm text-zinc-600">
              Share results with students and parents via SMS, email, or the parent portal.
              Enable parents to access detailed report cards and progress reports through the system.
              </div>
            </div>
          </div>
          ...
          <div className="flex overflow-hidden flex-col pt-10 pr-16 pb-20 pl-8 w-full font-inter bg-white rounded-lg shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              <div className="mt-8 text-sm text-zinc-600">
              Analyze individual or class performance across terms and years.
              Generate reports comparing students, classes, or subjects for actionable insights.
              </div>
            </div>
          </div>
        </div>
    ...
    Benefits of the Exam Management & Result/Report Card Module
    </h1>
    <Benefits />
    ...
    Revolutionize the Way You Manage Exams and Results
    </h1>
    <h4 className="text-lg mt-4 px-80 font-inter text-center max-md:max-w-full max-md:text-4xl" style={{
        color:'rgba(61, 96, 149, 1)'
    }}>
With the Exam Management & Result/Report Card Module, you can effortlessly handle all aspects of 
exams and report card generation, saving time, reducing stress, and delivering excellence.    </h4>
