...
const features = [
  {
    title: "Save Time: ",
    description: "Automate exam scheduling, result entry, and report card generation."
  },
  {
    title: "Ensure Accuracy: ",
    description: "Avoid errors in scoring, grading, and report creation with automated calculations."
  },
  {
    title: "Enhance Parent Communication: ",
    description: "Keep parents updated with instant notifications and accessible report cards."
  },
  {
    title: "Boost Transparency: ",
    description: "Provide detailed, professional-grade report cards that build trust and satisfaction."
    
  },
  {
    title: "Support Decision-Making:",
    description: "Use performance analytics to identify trends and improve academic outcomes."
  },
];
    ...
    <div className="rounded-none">
      <div className="flex mx-20 mt-20 max-md:flex-col">
          <div className="flex flex-col w-6/12 ml-10 -mr-32 max-md:ml-0 max-md:w-full">
            <img
              loading="lazy"
              src="Design_four_images/image 6.png"
