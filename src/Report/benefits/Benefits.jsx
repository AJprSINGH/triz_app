    ...
    >
      ...
      <div className="flex flex-wrap max-w-full w-full items-center justify-center mt-7">
        ...
        <div className="my-auto text-center justify-center text-3xl font-inter"style={{
         ...
         Benefits of the Reports Module
        </div>
      </div>
        ...
        <div className="flex flex-wrap gap-5 justify-center">
          ...
          <div className="flex flex-col w-2/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Informed Decision-Making</div>
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Gain actionable insights to support strategic planning and business growth.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Automate reporting workflows to save time and improve efficiency.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              <div className="self-stretch mt-4 text-sm leading-7 opacity-70">
              Share clear, concise reports with stakeholders for better communication.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start text-zinc-900 max-md:mt-10">
              ...
              />
              <div className="mt-4 text-lg font-inter leading-none">Improved Resource Management</div>
              <div className="mt-4 text-sm  opacity-70 leading-7 w-[350px]">
              Optimize processes using detailed analysis of tasks and HR data.
              </div>
              {/* <img
                loading="lazy"
