...
const features = [
  {
    ...
    title: "Easy Fees Collectionn",
    description:
      "Quickly collect fees using various payment methods (online, cash, cheque, and NACH).Centralized tracking of all transactions for better record management.",
  },
  {
    ...
    title: "Hassle-Free Refund & Cancellation",
    description:
      "Instant refunds for canceled or adjusted fees without delays.Ensure accountability with proper documentation for every refund.",
  },
  {
    ...
    description:
      "Send automated circulars to students and parents regarding fees and deadlines.Reduce manual effort and improve communication efficiency.",
  },
  {
    ...
    title: "Customizable Fee Categories",
    description:
      "Easily manage imprest fees, additional charges, and other fee categories.Tailor the system to your institution’s unique financial structure.",
  },
  {
    ...
    description:
      "Generate fee data in Excel format for audits, insights, and financial planning.Real-time access to fee statuses and collections for better decision-making.",
  },
  {
    ...
    description:
      "Quickly reconcile cheque payments with your institution's bank records.Minimize errors and enhance financial accuracy.",
  },
];
