...
<div className="lg:flex sm:hidden overflow-hidden flex-col justify-center items-start font-inter px-16 py-10 w-full max-md:px-5 max-md:py-24 max-md:max-w-full" style={{
    ...
    <div className="sm:flex lg:hidden overflow-x-hidden  flex-col justify-center items-start font-inter px-8 py-8 w-full max-md:px-5 max-md:py-24 max-md:max-w-full" style={{
  background: 'linear-gradient(0deg, #ffffff 29%, rgba(61, 96, 149, 1) 100%)',
}}>
  <div className="-mb-6 w-full max-w-full max-md:mb-2.5 max-md:max-w-full">
    <div className="lg:flex gap-5 max-md:flex-col">
      <div className="flex flex-col lg:w-[55%] max-md:ml-0 max-md:w-full">
        <div className="flex flex-col items-start mt-6 w-full text-2xl font-medium max-md:mt-10 max-md:max-w-full">
          ...
          <div className="flex flex-wrap gap-5 text-[10px] mt-6 max-w-full text-white lg:w-[547px] max-md:mt-10 max-md:flex-col max-md:gap-4">
            {ctaButtons.map((button, index) => (
              <button 
                key={index}
                className={`${button.className} w-full max-md:w-full max-md:text-base`}
                tabIndex={0}
                role="button"
                aria-label={button.text}
                style={{
      ...
      <div className="lg:flex flex-col lg:w-[45%] max-md:ml-0 max-md:w-full max-md:mt-6">
        <img
          loading="lazy"
          src="/Design_three_images/image 85.png"
          alt="User and teacher management interface demonstration"
          className="object-cover w-full h-full max-md:mt-0 max-md:max-w-full"
        />
      </div>
    </div>
  </div>
    ...
    <div className="rounded-none">
      ...
      <div className="sm:flex lg:hidden   mt-6 max-md:flex-col">
        {/* <div className="lg:flex flex-col lg:w-6/12 pr-2 max-md:ml-0 max-md:w-full">
          <img
            loading="lazy"
            src="Design_three_images/image 86.png"
            alt="Educational CRM platform interface showcase"
        ...
        <div className="flex lg:flex-col mx-5 lg:w-6/12 max-md:ml-0 max-md:w-full">
          <div className="flex flex-col self-stretch my-auto w-full max-md:mt-10 max-md:max-w-full">
          <h1 className="z-1 self-start mt-0 text-2xl font-inter tracking-tighter max-md:max-w-full" style={{
            color:'rgba(28, 81, 161, 1)'
          }}>
          Simplify and Optimize Front Desk Workflows
      </h1>
      <div className="z-10 mt-4 max-md:mt-10 max-md:max-w-full">
        <p className="text-xs font-interregular">Tackle the challenges of managing visitors, inquiries, and appointments with ease:</p>
        {features.map((feature, index) => (
          <div key={index} className="mb-1">
      ...
      <div className="lg:flex gap-5  self-end mt-2 max-w-full text-xs lg:w-[380px] max-md:mt-10">
              {HERO_BUTTONS.map((button, index) => (
                <button key={index}
                 className={`gap-5 self-stretch px-5  py-2 bg-sky-500 font-inter rounded-3xl text-white`}
                 tabIndex="0"
                 style={{
                    background:'rgba(17, 134, 254, 1)'
                 }}
    ...
    <h1 className="lg:text-4xl sm:text-2xl text-center font-intersemibold lg:mt-40 sm:mt-20"style={{
            color:'rgba(28, 81, 161, 1)'
    }}>
    ...
    <Features />
    <Benefits />
    <div className="rounded-none lg:mx-40 sm:mx-5 lg:mt-20">
      ...
      <div className="sm:flex lg:hidden gap-5 max-md:flex-col">
        {/* <div className="lg:flex flex-col lg:w-[22%] max-md:ml-0 max-md:w-full">
          <img
            loading="lazy"
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/28377e402529559884aaaa580e3e965cc682efca2b4743f9e17b7bb9ecac4c07?placeholderIfAbsent=true&apiKey=af5cfb29bb594d4e9f9e505ea3916323"
            className="object-contain grow shrink-0 mt-11 max-w-full aspect-[0.68] lg:w-[274px] max-md:mt-10"
          />
        </div> */}
        <div className="lg:flex flex-col lg:w-[78%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col w-full items-center justify-center  text-blue-800 max-md:max-w-full">
            <div className="text-[20px]  text-center font-ralewayextrabold max-md:max-w-full max-md:text-4xl">
              Take the Leap Toward an Efficient Front Desk
            </div>
            <div className="mt-4 text-1xl font-interregular max-md:mr-2.5 max-md:max-w-full">
              Your school&rsquo;s first impression matters. Make it count with Scholar
              Clone&rsquo;s Front Desk Management Module
            </div>
            <div className="flex lg:flex-wrap gap-10 text-white">
      <button
        className="px-5 py-2 mt-6 mb-10 text-xs font-inter bg-sky-500 rounded-xl max-md:mt-10 max-md:mr-2.5 max-md:mb-2.5"
        style={{
          background: 'rgba(28, 81, 161, 1)',
        }}
        onClick={() => {}}
