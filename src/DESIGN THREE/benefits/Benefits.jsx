    ...
    >
      ...
      <div className="flex flex-wrap max-w-full w-full items-center justify-center mt-7">
        {/* <img
          ...
          className="object-contain shrink-0 w-40 self-start max-w-full aspect-[0.87]"
        /> */}
        <div className="my-auto text-center mt-2 justify-center text-2xl font-inter"style={{
            color:'rgba(28, 81, 161, 1)'
    }}>
          Benefits Your School Will Unlock
        </div>
          ...
          <div className="flex flex-col lg:w-2/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start items-center text-zinc-900 max-md:mt-10">
              <img
                ...
                className="object-contain aspect-[0.94] w-[31px]"
              />
              <div className="mt-4 text-sm font-inter leading-none">Save Time</div>
              <div className="self-stretch mt-4 text-xs text-center leading-7 opacity-70">
                Automate repetitive tasks so staff can focus on higher priorities.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start items-center text-zinc-900 max-md:mt-10">
              <img
                ...
                className="object-contain aspect-square w-[35px]"
              />
              <div className="mt-4 text-sm font-inter leading-none">Increased Security</div>
              <div className="self-stretch mt-4 text-xs text-center leading-7 opacity-70">
                Monitor all campus entries and exits in real time.
              </div>
            </div>
          ...
          <div className="flex flex-col lg:w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start items-center text-zinc-900 max-md:mt-10">
              <img
                ...
                className="object-contain aspect-[0.9] w-[27px]"
              />
              <div className="mt-4 text-sm font-inter leading-none">Organized Data</div>
              <div className="self-stretch mt-4 text-xs text-center leading-7 opacity-70">
                Consolidate visitor, appointment, and inquiry records in one easily accessible platform.
              </div>
            </div>
          ...
          <div className="flex flex-col lg:w-3/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col items-start items-center text-zinc-900 max-md:mt-10">
              <img
                ...
                className="object-contain aspect-[1.03] w-[31px]"
              />
              <div className="mt-4 text-sm font-inter leading-none">Streamlined Communication</div>
              <div className="mt-4 text-xs  opacity-70 text-center leading-7 w-[350px]">
                Instantly notify staff about updates or schedule changes
              </div>
              {/* <img
                loading="lazy"
