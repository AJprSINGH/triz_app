...
const features = [
  {
    ...
    description:
      "Store employee records, company policies, contracts, and more in an organized and easily accessible digital library.",
  },
  {
    ...
    description:
      "Define user roles to maintain confidentiality while improving collaboration.Ensure only authorized personnel can access sensitive documents.",
  },
  {
    ...
    description:
      "Save time and improve operational efficiency with smart tagging and metadata tools.Use advanced search filters to quickly locate specific files or employee records.",
  },
  {
    ...
    description:
      "Get reminders for document updates, expiration dates, or compliance deadlines.Reduce the risk of missed renewals or non-compliance penalties.",
  },
  {
    ...
    description:
      "Connect the DMS with payroll, recruitment, and other HR modules for a unified experience.Enable cross-functional collaboration across departments.",
  },
  {
    ...
    description:
      "Enjoy peace of mind with automatic backups and easy recovery options.	Safeguard critical data from accidental loss or cyber threats.",
  },
];
  ...
  return (
    <div className="flex flex-col rounded-[48px] mx-40 mt-[10px]">
      <div className="self-center text-4xl font-bold text-center text-slate-500 max-md:max-w-full max-md:text-4xl"  style={{
        ...
        Key Features of Scholar Clone&apso;s Document Management System
      </div>
