...
const features = [
  {
    ...
    description:
      "Quickly create lesson plans, study guides, quizzes, and worksheets for any subject or topic. This feature ensures educators can spend more time teaching while providing students with targeted learning resources.",
  },
  {
    ...
    description:
      "The module identifies each student’s strengths and challenges, creating customized exercises and recommendations to help them progress at their own pace.",
  },
  {
    ...
    title: "Instant Question Assistance",
    description:
      "Students can ask questions naturally, and the AI provides clear and accurate answers, helping them understand concepts more easily.",
  },
  {
    ...
    title: "Creative Support for Projects",
    description:
      "Generate fresh ideas and structured guidance for essays, group projects, or problem-solving tasks. It’s a great tool for sparking curiosity and encouraging collaboration.",
  },
  {
    ...
    description:
      "Generate learning materials in different languages, making education accessible to a broader range of students with diverse language needs.",
  },
  {
    ...
    title: "Performance Insights and Feedback",
    description:
      "Track student progress and engagement with real-time analytics. The module provides detailed feedback, helping educators focus on areas that need improvement.",
  },
];
