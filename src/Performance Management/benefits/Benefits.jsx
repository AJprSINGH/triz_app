...
export default function Benefits() {
  return (
    <div className="flex overflow-hidden flex-col items-start px-10 pt-8 mt-20 pb-8 text-2xl font-bold bg-blue-200 max-md:px-5">
      <div className="lg:flex flex-col max-w-full w-full">
        ...
        <div className="flex flex-col sm:items-center lg:w-[50%] lg:pr-20">
        <BenefitCard
        ...
        <BenefitCard
          ...
          className="w-full max-md:px-5 max-md:mt-10 lg:ml-56 lg:mr-1  max-md:max-w-full font-inter"
        />
        </div>
        <div className="flex flex-col lg:mt-32 lg:ml-20  lg:w-[50%] sm:w-full">
        <img
          loading="lazy"
