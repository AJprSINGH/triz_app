...
export default function KeyFeatures() {
  return (
    <div className="flex flex-col rounded-[48px] lg:mx-40 mt-[10px]">
      <div className="self-center lg:text-4xl sm:text-2xl sm:mr-5 sm:ml-5 font-bold text-center text-slate-500 max-md:max-w-full max-md:text-4xl"  style={{
                color:'rgba(61, 96, 149, 1)'
            }}>
        Key Features of the Library Module
      </div>
      <div className="lg:flex flex-col items-center lg:px-20 sm:px-10 py-10 lg:mt-6  w-full bg-white rounded-[48px] max-md:px-5 max-md:mt-10 max-md:max-w-full"style={{
